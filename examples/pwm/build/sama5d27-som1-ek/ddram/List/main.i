...
extern void pwmc_set_dma_finished_callback(Pwm *pwm, struct _callback* cb);
...
#line 1 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\pwm\\config_sama5d27-som1-ek.h"
...
#line 157 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\pwm\\main.c"
...
static const struct _pin pins_pwm[] = { { 1, (1u << 1), 3, (1u << 0) } };
...
_Pragma("data_alignment = (32u)") _Pragma("location = \".region_cache_aligned\"") static uint16_t duty_buffer[100];



 
static const struct _pin pins_tc_capture[] = { { 2, (1u << 9), 3, (0) } };
...
static void _tc_fault_handler(uint32_t source, void* user_arg)
{
	...
	((source == get_tc_id_from_addr(tc_fault . addr, tc_fault . channel)) ? (void) 0 : (__aeabi_assert("source == get_tc_id_from_addr(tc_fault.addr, tc_fault.channel)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\pwm\\main.c", 358), (__iar_EmptyStepPoint())));
...
static void _tc_fault_initialize(void)
{
	...
	tc_set_fault_mode(tc_fault.addr, (0x1u << 0) << tc_fault.channel);
	tc_set_ra_rb_rc(tc_fault.addr, tc_fault.channel, ((void*)0), ((void*)0), &rc);

	tc_enable_it(tc_fault.addr, tc_fault.channel, (0x1u << 4));
	irq_add_handler(tc_id, _tc_fault_handler, ((void*)0));
	irq_enable(tc_id);
}
...
static void _pwm_handler(uint32_t source, void* user_arg)
{
	...
	do { if (trace_level >= 5) printf("-D- " "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\pwm\\main.c" ":" "412" " " "PWM handler, interrupt status 0x%08x 0x%08x, " "fault status 0x%08x\r\n", (unsigned)pwmc_get_it_status1(((Pwm *)0xF802C000U)), (unsigned)pwmc_get_it_status2(((Pwm *)0xF802C000U)), (unsigned)pwmc_get_fault_status(((Pwm *)0xF802C000U))); } while (0);
#line 417 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\pwm\\main.c"
}
...
static void _pwm_demo_asynchronous_channel(_Bool init, uint8_t channel, uint32_t cprd)
{
	...
	uint32_t id = get_pwm_id_from_addr(((Pwm *)0xF802C000U));

	if (init) {
		 
		pwmc_disable_channel(((Pwm *)0xF802C000U), channel);
		pwmc_configure_channel(((Pwm *)0xF802C000U), channel,
			(0x1u << 9) | (0x1u << 8) | (0xBu << 0));
		pwmc_set_period(((Pwm *)0xF802C000U), channel, cprd);
		pwmc_set_duty_cycle(((Pwm *)0xF802C000U), channel, 0);
		pwmc_enable_channel(((Pwm *)0xF802C000U), channel);
		duty_cycle = 0;
		duty_cycle_inc = 1;
		return;
	}
	...
	pwmc_set_duty_cycle(((Pwm *)0xF802C000U), channel, duty_cycle);
	msleep(50);
...
{
	do { if (trace_level >= 5) printf("-D- " "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\pwm\\main.c" ":" "469" " " "PWM DMA Transfer Finished\r\n"); } while (0);
	return 0;
}
...
static void _pwm_demo_dma(uint8_t channel, uint32_t cprd)
{
	...
	pwmc_disable_channel(((Pwm *)0xF802C000U), channel);
	pwmc_configure_sync_channels(((Pwm *)0xF802C000U),
		(0x2u << 16) | (1 << channel) | (1 << 0));
	pwmc_configure_channel(((Pwm *)0xF802C000U), 0,
		(0x1u << 9) | (0x1u << 8) | (0xBu << 0));
	pwmc_set_period(((Pwm *)0xF802C000U), 0, cprd);
	pwmc_set_duty_cycle(((Pwm *)0xF802C000U), 0, 0);
	pwmc_set_sync_channels_update_period(((Pwm *)0xF802C000U), 0, 8);
	 
	pwmc_enable_channel(((Pwm *)0xF802C000U), 0);
	for (i = 0; i < (sizeof ((duty_buffer)) / sizeof(*(duty_buffer))); i++) {
		if (0 == (i % cprd))
			flag = !flag;
		duty_buffer[i] = flag ? (i % cprd) : (cprd - (i % cprd));
	}
	callback_set(&_cb, _pwmc_callback, 0);
	pwmc_set_dma_finished_callback(((Pwm *)0xF802C000U), &_cb);
	pwmc_dma_duty_cycle(((Pwm *)0xF802C000U), duty_buffer, (sizeof ((duty_buffer)) / sizeof(*(duty_buffer))));
}
...
int main(void)
{
	...
	pwmc_configure_clocks(((Pwm *)0xF802C000U), (0xAu << 24) | (((0xffu << 16) & ((32) << 16))) |
	                           (0xAu << 8) | (((0xffu << 0) & ((32) << 0))));
	...
	while (1) {
		if (console_is_rx_ready()) {
			...
			case 'f':
				pwmc_set_fault_mode(((Pwm *)0xF802C000U), (((0xffu << 0) & ((1 << pwm_fault_input) << 0))) |
				                         (((0xffu << 8) & ((0) << 8))));
				pwmc_set_fault_mode(((Pwm *)0xF802C000U), (((0xffu << 0) & ((1 << pwm_fault_input) << 0))) |
				                         (((0xffu << 8) & ((1 << pwm_fault_input) << 8))));
				pwmc_set_fault_protection(((Pwm *)0xF802C000U), ((0x1u << 0) << pwm_channel) |
				                               ((0x1u << 16) << pwm_channel));

				pwmc_set_fault_protection_to_hiz(((Pwm *)0xF802C000U), 0);

				pwmc_fault_clear(((Pwm *)0xF802C000U), 1 << pwm_fault_input);
				pwmc_enable_fault_protection(((Pwm *)0xF802C000U), pwm_channel, 1 << pwm_fault_input);
				pwmc_enable_it(((Pwm *)0xF802C000U), (0x1u << 16) << pwm_channel, 0);
				_tc_fault_initialize();
				_tc_fault_start();
				break;
			case 'F':
				pwmc_enable_fault_protection(((Pwm *)0xF802C000U), pwm_channel, 0);
				pwmc_disable_it(((Pwm *)0xF802C000U), (0x1u << 16) << pwm_channel, 0);
				pwmc_fault_clear(((Pwm *)0xF802C000U), 1 << pwm_fault_input);
				break;
			...
			case 'm':
				pwmc_configure_stepper_motor_mode(((Pwm *)0xF802C000U),
					(0x1u << 0) | (0x1u << 1) | (0x1u << 16));
				break;
			...
			case 'o':
				...
				switch (key) {
				case '0':
					pwmc_output_override(((Pwm *)0xF802C000U), pwm_channel, 0, 0, 0);
					pwmc_output_override(((Pwm *)0xF802C000U), pwm_channel, 1, 0, 0);
					break;
				case '1':
					pwmc_output_override(((Pwm *)0xF802C000U), pwm_channel, 0, 1, 0);
					pwmc_output_override(((Pwm *)0xF802C000U), pwm_channel, 1, 1, 0);
					break;
				default:
					pwmc_output_dead_time(((Pwm *)0xF802C000U), pwm_channel, 0, 0);
					pwmc_disable_output_override(((Pwm *)0xF802C000U), pwm_channel, 0, 0);
					pwmc_disable_output_override(((Pwm *)0xF802C000U), pwm_channel, 1, 0);
					break;
				}
				break;
			...
			default:
				current_demo = 0;
				pwmc_disable_channel(((Pwm *)0xF802C000U), 0);
				pwmc_disable_channel(((Pwm *)0xF802C000U), pwm_channel);

				 
				pwmc_configure_sync_channels(((Pwm *)0xF802C000U), 0);


				pwmc_set_dma_finished_callback(((Pwm *)0xF802C000U), ((void*)0));


				pwmc_configure_stepper_motor_mode(((Pwm *)0xF802C000U), 0);

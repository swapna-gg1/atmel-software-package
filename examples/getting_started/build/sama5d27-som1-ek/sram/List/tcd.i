...
int tcd_configure_capture(struct _tcd_desc* desc, uint32_t frequency, struct _buffer* buffer)
{
	...
	((desc->capture . dma . channel) ? (void) 0 : (__aeabi_assert("desc->capture.dma.channel", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\peripherals\\tcd.c", 208), (__iar_EmptyStepPoint())));

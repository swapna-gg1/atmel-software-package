...
#line 353 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\extram\\ddram.c"
...
static void _init_mt47h128m8(struct _mpddrc_desc* desc)
{
	...
	desc->io_calibr = (((0x7u << 8) & ((((((((20)) * (mck)) + 999) / 1000) + 1)) << 8)));

	desc->io_calibr |= (((0x7u << 0) & ((4) << 0)));


	desc->io_calibr |= (0x1u << 4);
	...
	desc->timings.tras   = ((((40) * (mck)) + 999) / 1000);  
	...
	desc->timings.trrd   = ((((8) * (mck)) + 999) / 1000);   
	desc->timings.twtr   = ((((10) * (mck)) + 999) / 1000);  
	desc->timings.tmrd   = 2;                   
	desc->timings.trfc   = ((((128) * (mck)) + 999) / 1000); 
	desc->timings.txsnr  = ((((138) * (mck)) + 999) / 1000); 
	...
	desc->timings.tfaw   = ((((35) * (mck)) + 999) / 1000);  
...
#line 692 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\extram\\ddram.c"

#line 738 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\extram\\ddram.c"

#line 784 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\extram\\ddram.c"
...
{
	switch(device) {
#line 1052 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\extram\\ddram.c"
	case MT47H128M8:

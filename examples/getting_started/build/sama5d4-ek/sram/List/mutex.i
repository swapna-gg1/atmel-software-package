...
#line 48 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\arch\\arm\\cpuidle.h"
...
_Bool mutex_try_lock(mutex_t* mutex)
{
	...
	while (1)
	{
		...
		__asm volatile("strex %0, %1, [%2]" : "=&r"(value) : "r"(1), "r"(mutex));
		if (value == 0)  
			break;
	}
	dmb();
...
#line 78 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\arch\\arm\\mutex.c"

...
#line 138 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\peripherals\\wdt.c"
	mode &= ~((0x1u << 15) | (0xfffu << 16) | (0xfffu << 0));
	mode &= ~((0xfffu << 16) | (0xfffu << 0));
	((Wdt *)0xFC068640U)->WDT_MR = mode;
	usleep(100);
	if (en_int)
		mode |= (0x1u << 12);
	if (en_rst)
	...
	if (en_idlehlt)
		mode |= (0x1u << 29);
	((Wdt *)0xFC068640U)->WDT_MR = mode |
				  (((0xfffu << 16) & ((_wdt_compute_period(delta)) << 16))) |
				  (((0xfffu << 0) & ((_wdt_compute_period(counter)) << 0)));

}

void wdt_disable(void)
{
	((Wdt *)0xFC068640U)->WDT_MR = (0x1u << 15);
}

void wdt_restart()
{
	((Wdt *)0xFC068640U)->WDT_CR = (0xA5u << 24) | (0x1u << 0);
}
...
uint32_t wdt_get_status(void)
{
	...
	return ((Wdt *)0xFC068640U)->WDT_SR & ((0x1u << 0) | (0x1u << 1));
...
uint32_t wdt_get_counter_value(void)
{
	...
	return (((Wdt *)0xFC068640U)->WDT_MR & (0xfffu << 0)) >> 0;

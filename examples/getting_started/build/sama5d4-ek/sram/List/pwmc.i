...
void pwmc_configure_comparison_unit(Pwm *pwm, uint32_t x,
		uint32_t value, uint32_t mode)
{
	((x < 8) ? (void) 0 : (__aeabi_assert("x < 8", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\peripherals\\pwmc.c", 162), (__iar_EmptyStepPoint())));
...
void pwmc_configure_sync_channels(Pwm *pwm, uint32_t mode)
{
	...
	uint32_t sync_bits = mode & ((0x1u << 0) | (0x1u << 1) 				     | (0x1u << 2) | (0x1u << 3));
#line 262 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\peripherals\\pwmc.c"
	do { if (trace_level >= 5) printf("-D- " "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\peripherals\\pwmc.c" ":" "264" " " "pwm: SYNC CHs bitmap 0x%x, Update Mode %u, " , (unsigned)sync_bits, (unsigned)((mode & (0x3u << 16)) >> 16)); } while (0);
	...
	(((pwm_sr & (pwm->PWM_SCM ^ sync_bits)) == 0) ? (void) 0 : (__aeabi_assert("(pwm_sr & (pwm->PWM_SCM ^ sync_bits)) == 0", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\peripherals\\pwmc.c", 274), (__iar_EmptyStepPoint())));
	 
	((((mode & (0x3u << 16)) >> 16) != 3) ? (void) 0 : (__aeabi_assert("((mode & (0x3u << 16)) >> 16) != 3", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\peripherals\\pwmc.c", 276), (__iar_EmptyStepPoint())));

	 
	((((mode & (0x3u << 16)) >> 16) != 2) ? (void) 0 : (__aeabi_assert("((mode & (0x3u << 16)) >> 16) != 2", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\peripherals\\pwmc.c", 279), (__iar_EmptyStepPoint())));
...
void pwmc_set_sync_channels_update_period(Pwm *pwm,
		uint8_t counter, uint8_t period)
{
	pwm->PWM_SCUP = (((0xfu << 4) & ((counter) << 4))) | (((0xfu << 0) & ((period) << 0)));
}

void pwmc_set_sync_channels_update_period_update(Pwm *pwm, uint8_t period)
{
	pwm->PWM_SCUPUPD = (((0xfu << 0) & ((period) << 0)));
}
		...
		uint8_t is_pwmh, uint8_t level, uint8_t sync)
{
	...
	((channel < (sizeof ((pwm->PWM_CH)) / sizeof(*(pwm->PWM_CH)))) ? (void) 0 : (__aeabi_assert("channel < (sizeof ((pwm->PWM_CH)) / sizeof(*(pwm->PWM_CH)))", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\peripherals\\pwmc.c", 360), (__iar_EmptyStepPoint())));

	do { if (trace_level >= 5) printf("-D- " "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\peripherals\\pwmc.c" ":" "363" " " "pwm: CH%u PWM%c output overridden to %u\n\r", (unsigned)channel, (0 != is_pwmh) ? 'H' : 'L', (unsigned)level); } while (0);


	if (0 == is_pwmh)
		mask = (0x1u << 0) << channel;
	else
		mask = (0x1u << 16) << channel;
		...
		uint8_t is_pwmh, uint8_t sync)
{
	...
	((channel < (sizeof ((pwm->PWM_CH)) / sizeof(*(pwm->PWM_CH)))) ? (void) 0 : (__aeabi_assert("channel < (sizeof ((pwm->PWM_CH)) / sizeof(*(pwm->PWM_CH)))", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\peripherals\\pwmc.c", 390), (__iar_EmptyStepPoint())));

	do { if (trace_level >= 5) printf("-D- " "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\peripherals\\pwmc.c" ":" "393" " " "pwm: CH%u PWM%c output override disabled\n\r", (unsigned)channel, (0 != is_pwmh) ? 'H' : 'L'); } while (0);
		...
		uint16_t time_h, uint16_t time_l)
{
	...
	((channel < (sizeof ((pwm->PWM_CH)) / sizeof(*(pwm->PWM_CH)))) ? (void) 0 : (__aeabi_assert("channel < (sizeof ((pwm->PWM_CH)) / sizeof(*(pwm->PWM_CH)))", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\peripherals\\pwmc.c", 416), (__iar_EmptyStepPoint())));

	do { if (trace_level >= 5) printf("-D- " "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\peripherals\\pwmc.c" ":" "419" " " "pwm: CH%u output dead time H: %u, L: %u\n\r", (unsigned)channel, (unsigned)time_h, (unsigned)time_l); } while (0);



	uint32_t pwm_cprd = pwm->PWM_CH[channel].PWM_CPRD;
	uint32_t pwm_cdty = pwm->PWM_CH[channel].PWM_CDTY;
	((pwm_cprd - pwm_cdty >= time_h) ? (void) 0 : (__aeabi_assert("pwm_cprd - pwm_cdty >= time_h", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\peripherals\\pwmc.c", 424), (__iar_EmptyStepPoint())));
	((pwm_cdty >= time_l) ? (void) 0 : (__aeabi_assert("pwm_cdty >= time_l", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\peripherals\\pwmc.c", 425), (__iar_EmptyStepPoint())));


	dead_time = (((0xffffu << 0) & ((time_h) << 0))) | (((0xffffu << 16) & ((time_l) << 16)));
...
{
	volatile uint32_t tmp;
	((channel < (sizeof ((pwm->PWM_CH)) / sizeof(*(pwm->PWM_CH)))) ? (void) 0 : (__aeabi_assert("channel < (sizeof ((pwm->PWM_CH)) / sizeof(*(pwm->PWM_CH)))", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\peripherals\\pwmc.c", 465), (__iar_EmptyStepPoint())));
	tmp = pwm->PWM_FPE;
	tmp &= ~((0xffu << 0) << (8 * channel));
...
void pwmc_configure_spread_spectrum_mode(Pwm *pwm, uint32_t value)
{
	...
	if (0 == (pwm->PWM_SR & (1 << 0)))
		...
		pwm->PWM_SSPUP = (((0xffffffu << 0) & ((value) << 0)));
}
...
{
	do { if (trace_level >= 5) printf("-D- " "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\peripherals\\pwmc.c" ":" "504" " " "pwm: CH0-1 Gray Count %s %s, CH2-3 Gray Count %s %s\n\r", (0 != (value & (0x1u << 16))) ? "Down" : "Up", (0 != (value & (0x1u << 0))) ? "Enable" : "Disable", (0 != (value & (0x1u << 17))) ? "Down" : "Up", (0 != (value & (0x1u << 1))) ? "Enable" : "Disable"); } while (0);

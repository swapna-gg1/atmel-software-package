...
extern _Bool sfc_write(uint32_t index, uint32_t data);
...
extern _Bool sfc_are_data_registers_masked(void);
...
{
	uint32_t status = ((Sfc *)0xFC060000U)->SFC_SR;
	uint32_t err = 0;
...
{
	((index < (sizeof ((((Sfc *)0xFC060000U)->SFC_DR)) / sizeof(*(((Sfc *)0xFC060000U)->SFC_DR)))) ? (void) 0 : (__aeabi_assert("index < (sizeof ((((Sfc *)0xFC060000U)->SFC_DR)) / sizeof(*(((Sfc *)0xFC060000U)->SFC_DR)))", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\nvm\\sfc.c", 74), (__iar_EmptyStepPoint())));
	return ((Sfc *)0xFC060000U)->SFC_DR[index];
}

void sfc_enable(void)
{
	pmc_enable_peripheral((57));
}

void sfc_disable(void)
{
	pmc_disable_peripheral((57));
}

_Bool sfc_write(uint32_t index, uint32_t data)
{
	uint32_t status;

	((index < (sizeof ((((Sfc *)0xFC060000U)->SFC_DR)) / sizeof(*(((Sfc *)0xFC060000U)->SFC_DR)))) ? (void) 0 : (__aeabi_assert("index < (sizeof ((((Sfc *)0xFC060000U)->SFC_DR)) / sizeof(*(((Sfc *)0xFC060000U)->SFC_DR)))", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\nvm\\sfc.c", 92), (__iar_EmptyStepPoint())));

	 
	((Sfc *)0xFC060000U)->SFC_KR = (((0xffu << 0) & ((0xFB) << 0)));

	 
	((Sfc *)0xFC060000U)->SFC_DR[index] = data;

	 
	do {
		status = ((Sfc *)0xFC060000U)->SFC_SR;
	} while ((status & (0x1u << 0)) == 0);

	 
	return (status & (0x1u << 1)) == 0;
}

void sfc_mask_data_registers(void)
{
	((Sfc *)0xFC060000U)->SFC_MR |= (0x1u << 0);
}

_Bool sfc_are_data_registers_masked(void)
{
	return (((Sfc *)0xFC060000U)->SFC_MR & (0x1u << 0)) != 0;
}

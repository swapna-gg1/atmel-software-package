...
extern void rstc_set_user_reset_enable(_Bool enable);




 
extern void rstc_set_user_reset_interrupt_enable(_Bool enable);



#line 74 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\getting_started\\..\\..\\drivers\\peripherals/rstc.h"
...
void rstc_set_user_reset_enable(_Bool enable)
{
	uint32_t mr = ((Rstc *)0xFC068600U)->RSTC_MR;
	if (enable) {
		mr |= (0x1u << 0);
	} else {
		mr &= ~(0x1u << 0);
	}
	((Rstc *)0xFC068600U)->RSTC_MR = mr | (0xA5u << 24);
}

void rstc_set_user_reset_interrupt_enable(_Bool enable)
{
	uint32_t mr = ((Rstc *)0xFC068600U)->RSTC_MR;
	if (enable) {
		mr |= (0x1u << 4);
...
#line 82 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\peripherals\\rstc.c"

void rstc_reset_processor_and_peripherals(void)
{

	((Rstc *)0xFC068600U)->RSTC_CR = (0x1u << 2) | (0x1u << 0) | (0xA5u << 24);
...
{
	((Rstc *)0xFC068600U)->RSTC_CR = (0x1u << 0) | (0xA5u << 24);
}

void rstc_reset_peripherals(void)
{

	((Rstc *)0xFC068600U)->RSTC_CR = (0x1u << 2) | (0xA5u << 24);
...
void rstc_reset_all(void)
{
	...
	((Rstc *)0xFC068600U)->RSTC_CR = cr;
}

_Bool rstc_get_nrst_level(void)
{
	return (((Rstc *)0xFC068600U)->RSTC_SR & (0x1u << 16)) != 0;
}

_Bool rstc_is_user_reset_detected(void)
{
	return (((Rstc *)0xFC068600U)->RSTC_SR & (0x1u << 0)) != 0;
}

_Bool rstc_is_busy(void)
{
	return (((Rstc *)0xFC068600U)->RSTC_SR & (0x1u << 17)) != 0;
}

uint32_t rstc_get_status(void)
{
	return ((Rstc *)0xFC068600U)->RSTC_SR;
}

...
#line 126 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\getting_started\\..\\..\\drivers\\nvm/i2c/at24.h"
...
void board_cfg_twi_bus(void)
{
	...
	const struct _pin pins_twi_bus0[] = { { 3, (1u << 21), 2, (0) }, { 3, (1u << 22), 2, (0) } };
	pio_configure(pins_twi_bus0, (sizeof ((pins_twi_bus0)) / sizeof(*(pins_twi_bus0))));
	iface.i2c.hw = ((Twi *)0xFC018600U);
	iface.i2c.freq = 400000;
	iface.transfer_mode = BUS_TRANSFER_MODE_DMA;
	bus_configure(((((BUS_TYPE_I2C) == BUS_TYPE_SPI) ? 0 : (((BUS_TYPE_I2C) == BUS_TYPE_I2C) ? ((6)) : (-((6) + (7)) - 1))) + (0)), &iface);


	const struct _pin pins_twi_bus1[] = { { 3, (1u << 4), 0, (0) }, { 3, (1u << 5), 0, (0) },};
	pio_configure(pins_twi_bus1, (sizeof ((pins_twi_bus1)) / sizeof(*(pins_twi_bus1))));
	iface.i2c.hw = ((Twi *)0xFC028000U);
	iface.i2c.freq = 400000;
	iface.transfer_mode = BUS_TRANSFER_MODE_DMA;
	bus_configure(((((BUS_TYPE_I2C) == BUS_TYPE_SPI) ? 0 : (((BUS_TYPE_I2C) == BUS_TYPE_I2C) ? ((6)) : (-((6) + (7)) - 1))) + (1)), &iface);

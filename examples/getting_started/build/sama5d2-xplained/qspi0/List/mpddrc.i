...
#line 79 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\extram\\mpddrc.c"
	((Mpddrc *)0xF000C000U)->MPDDRC_TPR0 = (((0xfu << 28) & ((desc->timings . tmrd) << 28)))
	...
	((Mpddrc *)0xF000C000U)->MPDDRC_TPR1 = (((0xfu << 24) & ((desc->timings . txp) << 24)))
	...
	((Mpddrc *)0xF000C000U)->MPDDRC_TPR2 = (((0xfu << 16) & ((desc->timings . tfaw) << 16)))
...
#line 116 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\extram\\mpddrc.c"
	nc = ((((Mpddrc *)0xF000C000U)->MPDDRC_CR & (0x3u << 0)) >> 0) + 9;
	nr = ((((Mpddrc *)0xF000C000U)->MPDDRC_CR & (0x3u << 2)) >> 2) + 11;
	interleaved = (((Mpddrc *)0xF000C000U)->MPDDRC_CR & (0x1u << 22)) != 0;
	dbw16 = (((Mpddrc *)0xF000C000U)->MPDDRC_MD & (0x1u << 4)) != 0;
...
{
	((Mpddrc *)0xF000C000U)->MPDDRC_MR = cmd & (0x7u << 0);
	((Mpddrc *)0xF000C000U)->MPDDRC_MR;
	dmb();
...
{
	((Mpddrc *)0xF000C000U)->MPDDRC_MR = (0x5u << 0);
	((Mpddrc *)0xF000C000U)->MPDDRC_MR;
	dmb();
...
{
	((Mpddrc *)0xF000C000U)->MPDDRC_MR = (0x7u << 0) | (((0xffu << 8) & ((mrs) << 8)));
	((Mpddrc *)0xF000C000U)->MPDDRC_MR;
	dmb();
...
static void _configure_ddr3(struct _mpddrc_desc* desc)
{
	...
	((Mpddrc *)0xF000C000U)->MPDDRC_CR |= (0x1u << 7);
...
static void _configure_ddr2(struct _mpddrc_desc* desc)
{
	...
	((Mpddrc *)0xF000C000U)->MPDDRC_CR |= (0x7u << 12);
...
static void _configure_lpddr2(struct _mpddrc_desc* desc)
{
	...
	((Sfr *)0xF8030000U)->SFR_DDRCFG |= (0x1u << 16) | (0x1u << 17);
...
extern void mpddrc_configure(struct _mpddrc_desc* desc)
{
	...
	pmc_configure_peripheral((13), ((void*)0), 1);

	pmc_enable_system_clock(PMC_SYSTEM_CLOCK_DDR);

	 
	((Mpddrc *)0xF000C000U)->MPDDRC_MD = desc->mode;


	 
	uint32_t value = ((Mpddrc *)0xF000C000U)->MPDDRC_IO_CALIBR;
	...
	((Mpddrc *)0xF000C000U)->MPDDRC_IO_CALIBR = value;



	((Mpddrc *)0xF000C000U)->MPDDRC_RD_DATA_PATH = desc->data_path;
	...
	((Mpddrc *)0xF000C000U)->MPDDRC_CR = desc->control;

	uint32_t lpr_prv = ((Mpddrc *)0xF000C000U)->MPDDRC_LPR, lpr = lpr_prv;
	...
	if (sfrbu_is_ddr_backup_enabled())
		...
		lpr = (lpr & ~(0x3u << 0)) | (0x1u << 0);

	if (lpr != lpr_prv)
		((Mpddrc *)0xF000C000U)->MPDDRC_LPR = lpr;
...
#line 564 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\extram\\mpddrc.c"
	...
	((Mpddrc *)0xF000C000U)->MPDDRC_RTR = (((0xfffu << 0) & ((desc->refresh_window * master_clock / desc->refresh_cycles) << 0)));


	if (sfrbu_is_ddr_backup_enabled()) {
		((Mpddrc *)0xF000C000U)->MPDDRC_MR = (0x0u << 0);
...
{
	uint32_t value;
	value = ((Mpddrc *)0xF000C000U)->MPDDRC_LPR & ~(0x3u << 0);
	((Mpddrc *)0xF000C000U)->MPDDRC_LPR = value | (cmd & (0x3u << 0));


	if (cmd == (0x1u << 0))
		 
		while (!((((Mpddrc *)0xF000C000U)->MPDDRC_LPR) & (0x1u << 25))) ;

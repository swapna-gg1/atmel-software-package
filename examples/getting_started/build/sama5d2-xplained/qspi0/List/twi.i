...
uint32_t twi_configure_master(Twi *twi, uint32_t twi_clock)
{
	...
	((id < (79)) ? (void) 0 : (__aeabi_assert("id < (79)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\i2c\\twi.c", 126), (__iar_EmptyStepPoint())));
	...
	for (ck_div = 0; ck_div < 7; ck_div++) {
		clh_div = ((clock / twi_clock) - 2 * (3)) >> ck_div;
		if (clh_div <= 511)
			break;
	}
	...
	return clock / ((clh_div << ck_div) + 2 * (3));
}
...
{
	((twi != ((void*)0)) ? (void) 0 : (__aeabi_assert("twi != ((void*)0)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\i2c\\twi.c", 308), (__iar_EmptyStepPoint())));

	 
	twi->TWI_FMR = (((0x3fu << 16) & ((tx_thres) << 16))) | (((0x3fu << 24) & ((rx_thres) << 24))) | rdym;
}

void twi_fifo_enable(Twi *twi, _Bool master)
{
	((twi != ((void*)0)) ? (void) 0 : (__aeabi_assert("twi != ((void*)0)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\i2c\\twi.c", 316), (__iar_EmptyStepPoint())));

	 
	twi->TWI_CR = (0x1u << 3) | (0x1u << 5);
	twi->TWI_CR = (0x1u << 28);
	twi->TWI_CR = (0x1u << 24) | (0x1u << 25);
...
void twi_fifo_disable(Twi *twi, _Bool master)
{
	((twi != ((void*)0)) ? (void) 0 : (__aeabi_assert("twi != ((void*)0)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\i2c\\twi.c", 331), (__iar_EmptyStepPoint())));
...
{
	((twi != ((void*)0)) ? (void) 0 : (__aeabi_assert("twi != ((void*)0)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\i2c\\twi.c", 346), (__iar_EmptyStepPoint())));

	return (twi->TWI_FLR & (0x3fu << 16)) >> 16;
}

uint32_t twi_fifo_get_tx_size(Twi *twi)
{
	((twi != ((void*)0)) ? (void) 0 : (__aeabi_assert("twi != ((void*)0)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\i2c\\twi.c", 353), (__iar_EmptyStepPoint())));

	return (twi->TWI_FLR & (0x3fu << 0)) >> 0;
}
...
uint8_t twi_fifo_write(Twi *twi, uint8_t *data, uint8_t size)
{
	...
	((twi != ((void*)0)) ? (void) 0 : (__aeabi_assert("twi != ((void*)0)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\i2c\\twi.c", 362), (__iar_EmptyStepPoint())));
...
uint8_t twi_fifo_read(Twi *twi, uint8_t *data, uint8_t size)
{
	...
	((twi != ((void*)0)) ? (void) 0 : (__aeabi_assert("twi != ((void*)0)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\i2c\\twi.c", 384), (__iar_EmptyStepPoint())));
...
{
	((twi != ((void*)0)) ? (void) 0 : (__aeabi_assert("twi != ((void*)0)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\i2c\\twi.c", 404), (__iar_EmptyStepPoint())));
	twi->TWI_CR = (0x1u << 25);
}

void twi_fifo_flush_tx(Twi *twi)
{
	((twi != ((void*)0)) ? (void) 0 : (__aeabi_assert("twi != ((void*)0)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\i2c\\twi.c", 410), (__iar_EmptyStepPoint())));
	twi->TWI_CR = (0x1u << 24);
}

_Bool twi_fifo_is_locked(Twi *twi)
{
	((twi != ((void*)0)) ? (void) 0 : (__aeabi_assert("twi != ((void*)0)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\i2c\\twi.c", 416), (__iar_EmptyStepPoint())));
	return twi->TWI_SR & (0x1u << 23);
}

void twi_fifo_unlock(Twi *twi)
{
	((twi != ((void*)0)) ? (void) 0 : (__aeabi_assert("twi != ((void*)0)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\i2c\\twi.c", 422), (__iar_EmptyStepPoint())));
	twi->TWI_CR = (0x1u << 26);
}

...
void board_cfg_pdmic(void)
{
	...
	const struct _pin pins_pdmic[] = { { 1, (1u << 26) | (1u << 27), 3, (0) },};
	pio_configure(pins_pdmic, (sizeof ((pins_pdmic)) / sizeof(*(pins_pdmic))));
...
void board_cfg_classd(void)
{
	...
	const struct _pin pins_classd[] = { { 1, (1u << 1), 5, (0) }, { 1, (1u << 2), 5, (0) }, { 1, (1u << 3), 5, (0) }, { 1, (1u << 4), 5, (0) } };
...
void board_cfg_i2sc(void)
{

	const struct _pin pins_i2sc0[] = { { 2, ( (1u << 1)| (1u << 2) | (1u << 3) | (1u << 4) | (1u << 5)), 4, (0) },};
	pio_configure(pins_i2sc0, (sizeof ((pins_i2sc0)) / sizeof(*(pins_i2sc0))));
...
void board_cfg_ssc(void)
{
	...
	const struct _pin pins_ssc0[] = { { 2, ((1u << 20) | (1u << 21) | (1u << 22)) | ((1u << 23) | (1u << 24) | (1u << 25)), 2, (0) },};
	pio_configure(pins_ssc0, (sizeof ((pins_ssc0)) / sizeof(*(pins_ssc0))));


	const struct _pin pins_ssc1[] = { { 0, ((1u << 14) | (1u << 15) | (1u << 16)) | ((1u << 17) | (1u << 18) | (1u << 19)), 1, (0) },};
	pio_configure(pins_ssc1, (sizeof ((pins_ssc1)) / sizeof(*(pins_ssc1))));

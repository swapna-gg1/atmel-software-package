...
static void _ssc_dma_rx_transfer(struct _ssc_desc* desc, struct _buffer* buffer)
{
	...
	((id < (79)) ? (void) 0 : (__aeabi_assert("id < (79)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\ssc.c", 102), (__iar_EmptyStepPoint())));
...
static void _ssc_dma_tx_transfer(struct _ssc_desc* desc, struct _buffer* buffer)
{
	...
	((id < (79)) ? (void) 0 : (__aeabi_assert("id < (79)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\ssc.c", 139), (__iar_EmptyStepPoint())));

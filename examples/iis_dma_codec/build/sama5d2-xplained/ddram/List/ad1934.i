#line 1 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\ad1934.c"
...
#line 35 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\ad1934.c"
...
#line 37 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\ad1934.c"


#line 1 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\iis_dma_codec\\..\\..\\drivers\\audio/ad1934.h"
...
#line 39 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\iis_dma_codec\\..\\..\\drivers\\audio/ad1934.h"
...
#line 40 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\iis_dma_codec\\..\\..\\drivers\\audio/ad1934.h"
...
extern void ad1934_master_volume_mute(struct _ad1934_desc* ad1934, _Bool mute);
...
extern _Bool ad1934_set_tdm_slot(struct _ad1934_desc* ad1934, int slots);
...
extern _Bool ad1934_set_word_width(struct _ad1934_desc* ad1934, uint8_t word_len);
...
extern _Bool ad1934_set_sample_rate(struct _ad1934_desc* ad1934, uint32_t sample_rate);
#line 40 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\ad1934.c"
...
#line 41 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\ad1934.c"
...
#line 42 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\ad1934.c"
...
#line 69 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\ad1934.c"
...
#line 101 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\ad1934.c"
...
#line 117 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\ad1934.c"

#line 126 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\ad1934.c"
...
static uint8_t ad1934_read_reg(struct _ad1934_desc* ad1934, uint8_t reg_addr)
{
	...
	bus_transfer(ad1934->bus, ad1934->dev->spi_dev.chip_select, buf, 2, ((void*)0));
...
static void ad1934_write_reg(struct _ad1934_desc* ad1934, uint8_t reg_addr, uint8_t data)
{
	...
	bus_start_transaction(ad1934->bus);
	bus_transfer(ad1934->bus, ad1934->dev->spi_dev.chip_select, &out, 1, ((void*)0));
	bus_stop_transaction(ad1934->bus);
...
void ad1934_configure(struct _ad1934_desc* ad1934)
{
	...
	ad1934_write_reg(ad1934, 0x05, 0x0);

	 
	ad1934_write_reg(ad1934, 0x00,
		0x00 | (0 << 1) | (3 << 3) |
		(0 << 5) | (1 << 7));

	 
	ad1934_write_reg(ad1934, 0x02, (1 << 6));

	 
	ad1934_write_reg(ad1934, 0x03,
		(0 << 0) | (0 << 3) |
		(1 << 4) | (1 << 5) |
		(1 << 6) | (0 << 7));
}
...
void ad1934_master_volume_mute(struct _ad1934_desc* ad1934, _Bool mute)
{
	uint8_t val = ad1934_read_reg(ad1934, 0x04);
	if (mute)
		ad1934_write_reg(ad1934, 0x04, val | 1);
	else
		ad1934_write_reg(ad1934, 0x04, val & ~1);
}


_Bool ad1934_set_tdm_slot(struct _ad1934_desc* ad1934, int slots)
{
	uint32_t channels;
	uint8_t val;
	...
	val = ad1934_read_reg(ad1934, 0x03);
	ad1934_write_reg(ad1934, 0x03,
			(val & ~(3 << 1)) | (channels << 1));
...
_Bool ad1934_set_sample_rate(struct _ad1934_desc* ad1934, uint32_t sample_rate)
{
	uint8_t val, fs;
	switch (sample_rate) {
	case 32000:
	...
	val = ad1934_read_reg(ad1934, 0x02);
	ad1934_write_reg(ad1934, 0x02,
			(val & ~(3 << (1)))
				| (fs << (1)));
	return 1;
}
...
_Bool ad1934_set_word_width(struct _ad1934_desc* ad1934, uint8_t word_len)
{
	uint8_t val;
	...
	val = ad1934_read_reg(ad1934, 0x04);
	ad1934_write_reg(ad1934, 0x04,
			(val & ~(3 << 3)) | (word_len << 3));

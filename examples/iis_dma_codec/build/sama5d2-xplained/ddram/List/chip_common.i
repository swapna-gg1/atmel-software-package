...
uint32_t get_i2sc_id_from_addr(const I2sc* addr)
{

	if (addr == ((I2sc *)0xF8050000U))
		return (43);
...
uint32_t get_pdmic_id_from_addr(const Pdmic* addr)
{
	...
	if (addr == ((Pdmic *)0xF8018000U))
		return (48);
#line 388 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\target\\common\\chip_common.c"
	return (79);
}
...
uint32_t get_ssc_id_from_addr(const Ssc* addr)
{
	...
	if (addr == ((Ssc *)0xF8004000U))
		return (43);


	if (addr == ((Ssc *)0xFC004000U))
		return (44);

#line 1 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\pdmic.c"
...
#line 35 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\pdmic.c"
...
#line 36 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\pdmic.c"
...
#line 37 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\pdmic.c"

#line 1 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\iis_dma_codec\\..\\..\\drivers\\audio/pdmic.h"
...
#line 38 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\iis_dma_codec\\..\\..\\drivers\\audio/pdmic.h"
...
#line 39 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\iis_dma_codec\\..\\..\\drivers\\audio/pdmic.h"
...
#line 41 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\iis_dma_codec\\..\\..\\drivers\\audio/pdmic.h"
...
#line 42 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\iis_dma_codec\\..\\..\\drivers\\audio/pdmic.h"
...
#line 43 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\iis_dma_codec\\..\\..\\drivers\\audio/pdmic.h"
...
#line 44 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\iis_dma_codec\\..\\..\\drivers\\audio/pdmic.h"
...
#line 45 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\iis_dma_codec\\..\\..\\drivers\\audio/pdmic.h"
...
#line 39 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\pdmic.c"
...
#line 43 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\pdmic.c"
...
#line 44 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\pdmic.c"
...
#line 45 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\pdmic.c"
...
#line 46 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\pdmic.c"
...
int pdmic_configure(struct _pdmic_desc *desc)
{
	...
	desc->addr->PDMIC_CR = (desc->addr->PDMIC_CR & ~(0x1u << 4)) | (0x1u << 0);

	if (desc->channels != 1) {
		do { if (trace_level >= 2) printf("-E- " "only supports one channel\n"); } while (0);
		return -(28);
	}
	...
	switch (desc->dsp_osr) {
	case (64):
		dspr0_val |= (((0x7u << 4) & ((1) << 4)));
		break;

	case (128):
		dspr0_val |= (((0x7u << 4) & ((0) << 4)));
		break;
	...
	if (desc->dsp_shift < (16))
		dspr0_val |= (((0xfu << 12) & ((desc->dsp_shift) << 12)));
	else
		return -(28);

	if (desc->dsp_scale < (16))
		dspr0_val |= (((0xfu << 8) & ((desc->dsp_scale) << 8)));
	else
		return 0;

	dspr1_val = (((0xffffu << 16) & ((desc->dsp_offset) << 16)));

	if (desc->dsp_dgain < (32768))
		dspr1_val |= (((0x7fffu << 0) & ((desc->dsp_dgain) << 0)));
	else
		return -(28);
	...
	if (pclk_prescal < (128)) {
		mr_val = (((0x7fu << 8) & ((pclk_prescal) << 8))) | (0x0u << 4);
	} else if (gclk_prescal < (128)) {
		mr_val = (((0x7fu << 8) & ((gclk_prescal) << 8))) | (0x1u << 4);
	} else {
		do { if (trace_level >= 2) printf("-E- " "PDMIC Prescal configure error"); } while (0);
		return -(28);
	}

	desc->rx.dma.channel = dma_allocate_channel(id, 0xFF);
	((desc->rx . dma . channel) ? (void) 0 : (__aeabi_assert("desc->rx.dma.channel", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\pdmic.c", 237), (__iar_EmptyStepPoint())));
...
int pdmic_set_gain(struct _pdmic_desc* desc, uint16_t dgain, uint8_t scale)
{
	...
	if (dgain < (32768) &&
			scale < (16)) {
		dspr0_scale = (((0xfu << 8) & ((scale) << 8)));
		dspr1_dgain = (((0x7fffu << 0) & ((dgain) << 0)));

		desc->addr->PDMIC_DSPR0 &= ~(0xfu << 8);
		desc->addr->PDMIC_DSPR1 &= ~(0x7fffu << 0);
...
void pdmic_stream_convert(struct _pdmic_desc* desc, _Bool flag)
{
	if (flag)
		desc->addr->PDMIC_CR |= (0x1u << 4);
	else
		desc->addr->PDMIC_CR &= ~(0x1u << 4);
}
...
int pdmic_init(struct _pdmic_desc *desc)
{
	...
	do { if (trace_level >= 5) printf("-D- " "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\pdmic.c" ":" "286" " " "-- PDMIC PCLK: %uMHz --\n\r", (unsigned)(pclk / 1000000)); } while (0);
	...
	do { if (trace_level >= 5) printf("-D- " "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\pdmic.c" ":" "302" " " "-- PDMIC GCLK: %uMHz --\n\r", (unsigned)(gclk / 1000000)); } while (0);
...
_Bool pdmic_data_ready(struct _pdmic_desc* desc)
{
	return (desc->addr->PDMIC_ISR & (0x1u << 24)) == (0x1u << 24);
}
...
_Bool pdmic_rx_transfer_is_done(struct _pdmic_desc* desc)
{

...
static _Bool _dspclk_configure(uint32_t dsp_clk)
{
...

	{
		...
		do { if (trace_level >= 5) printf("-D- " "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\classd.c" ":" "106" " " "Configured Audio PLL PMC Clock: %u (= 8 * %u)\r\n", (unsigned)clk, (unsigned)(clk >> 3)); } while (0);

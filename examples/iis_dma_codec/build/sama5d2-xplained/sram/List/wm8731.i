#line 1 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\wm8731.c"
...
#line 15 "C:\\Program Files (x86)\\IAR Systems\\Embedded Workbench 8.4\\arm\\inc\\c\\iccarm_builtin.h"
...
#line 70 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\iis_dma_codec\\..\\..\\utils\\trace.h"
...
#line 72 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\iis_dma_codec\\..\\..\\utils\\trace.h"
...
#line 42 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\wm8731.c"
#line 1 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\iis_dma_codec\\..\\..\\drivers\\audio/wm8731.h"
...
#line 41 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\iis_dma_codec\\..\\..\\drivers\\audio/wm8731.h"
...
#line 38 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\iis_dma_codec\\..\\..\\drivers\\i2c/twid.h"
...
#line 39 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\iis_dma_codec\\..\\..\\drivers\\i2c/twid.h"
...
#line 42 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\iis_dma_codec\\..\\..\\drivers\\audio/wm8731.h"
...
#line 43 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\wm8731.c"
...
#line 44 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\wm8731.c"
...
#line 46 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\wm8731.c"
...
#line 48 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\wm8731.c"
...
static void wm8731_write(struct _wm8731_desc *wm8731, uint8_t reg_addr, uint16_t data)
{
	...
	bus_transfer(wm8731->twi.bus, wm8731->twi.addr, buf, 2, ((void*)0));
...
void wm8731_configure(struct _wm8731_desc *wm8731)
{
	...
	wm8731_write(wm8731, 0x1E, 0);

	 
	wm8731_write(wm8731, 0x0, 0x1A);
	 
	wm8731_write(wm8731, 0x1, 0x1A);

	 
	wm8731_write(wm8731, 0x2, 0x60);
	 
	wm8731_write(wm8731, 0x3, 0x60);

	 
	wm8731_write(wm8731, 0x4, 0x12);

	 
	wm8731_write(wm8731, 0x5, 0);

	 
	wm8731_write(wm8731, 0x7, (0x2 << 0) | (0x1 << 6));

	 
	wm8731_write(wm8731, 0x8, (0x1 << 0) | (0x1 << 6));

	 
	wm8731_write(wm8731, 0x6, 0x0);

	 
	wm8731_write(wm8731, 0x9, 0x01);
...
void wm8731_set_left_volume(struct _wm8731_desc *wm8731, uint8_t vol)
{
	uint16_t reg_value;
	vol &= (0x7f << 0);
	vol = (vol * 80 / 63 + (0x30 << 0)) > (0x7f << 0)
		  ? (0x7f << 0) : (vol * 80 / 63 + (0x30 << 0));
	reg_value = (0x1 << 8) | (0x1 << 7) | vol;
	wm8731_write(wm8731, 0x2, reg_value);
}
...
void wm8731_set_right_volume(struct _wm8731_desc *wm8731, uint8_t vol)
{
	...
	vol = (vol * 80 / 63 + (0x30 << 0)) > (0x7f << 0)
		  ? (0x7f << 0) : (vol * 80 / 63 + (0x30 << 0));
	reg_value = (0x1 << 7) | (0x1 << 8) | vol ;
	wm8731_write(wm8731, 0x3, reg_value);
}

void wm8731_volume_mute(struct _wm8731_desc *wm8731, _Bool mute)
{
	if (mute) {
		wm8731_write(wm8731, 0x5, (0x1 << 3));
	} else {
		wm8731_write(wm8731, 0x5, (0x0 << 3));
	}
}

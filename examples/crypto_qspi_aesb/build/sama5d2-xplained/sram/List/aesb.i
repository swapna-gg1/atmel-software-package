#line 1 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\crypto\\aesb.c"
...
#line 42 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\crypto\\aesb.c"
...
#line 43 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\crypto\\aesb.c"
...
{
	((Aesb *)0xF001C000U)->AESB_CR = (0x1u << 0);
}
...
{
	((Aesb *)0xF001C000U)->AESB_CR = (0x1u << 8);
}
...
{
	((Aesb *)0xF001C000U)->AESB_IER = sources;
}
...
{
	((Aesb *)0xF001C000U)->AESB_IDR = sources;
}
...
{
	return ((Aesb *)0xF001C000U)->AESB_ISR;
}
...
{
	((Aesb *)0xF001C000U)->AESB_KEYWR[0] = pKey[0];
	((Aesb *)0xF001C000U)->AESB_KEYWR[1] = pKey[1];
	((Aesb *)0xF001C000U)->AESB_KEYWR[2] = pKey[2];
	((Aesb *)0xF001C000U)->AESB_KEYWR[3] = pKey[3];
}
...
void aesb_set_input(uint32_t * data)
{
	uint8_t i;
	for (i = 0; i < 4; i++)
		((Aesb *)0xF001C000U)->AESB_IDATAR[i] = data[i];
}
...
void aesb_get_output(uint32_t * data)
{
	uint8_t i;
	for (i = 0; i < 4; i++)
		data[i] = ((Aesb *)0xF001C000U)->AESB_ODATAR[i];
}
...
{
	((Aesb *)0xF001C000U)->AESB_IVR[0] = vector[0];
	((Aesb *)0xF001C000U)->AESB_IVR[1] = vector[1];
	((Aesb *)0xF001C000U)->AESB_IVR[2] = vector[2];
	((Aesb *)0xF001C000U)->AESB_IVR[3] = vector[3];
}

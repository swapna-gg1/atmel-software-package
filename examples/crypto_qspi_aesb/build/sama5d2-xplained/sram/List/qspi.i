...
#line 215 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\spi\\qspi.c"
...
#line 330 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\spi\\qspi.c"
...
#line 361 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\spi\\qspi.c"
...
#line 460 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\spi\\qspi.c"
	...
	qspi->QSPI_IAR = iar;
#line 470 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\spi\\qspi.c"
	qspi->QSPI_ICR = icr;
	...
	if ((((cmd->flags & (0x7UL << 0)) == (0x1UL << 0)) &&
	     ...
	     ((((uint32_t)(cmd->tx_data)) & ((32u) - 1)) == 0) &&
	     ((((uint32_t)(cmd->data_len)) & ((32u) - 1)) == 0)) ||
	    (((cmd->flags & (0x7UL << 0)) == (0x0UL << 0)) &&
           
	     ((((uint32_t)(cmd->rx_data)) & ((32u) - 1)) == 0) &&
	     ((((uint32_t)(cmd->data_len)) & ((32u) - 1)) == 0)))
		use_dma = 1;

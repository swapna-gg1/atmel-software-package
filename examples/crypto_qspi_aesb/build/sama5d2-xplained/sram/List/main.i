#line 1 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\crypto_qspi_aesb\\main.c"
...
#line 94 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\crypto_qspi_aesb\\main.c"
...
#line 95 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\crypto_qspi_aesb\\main.c"
...
#line 96 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\crypto_qspi_aesb\\main.c"
...
#line 98 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\crypto_qspi_aesb\\main.c"
#line 1 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\crypto_qspi_aesb\\..\\..\\target\\common\\board_spi.h"
...
#line 39 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\crypto_qspi_aesb\\..\\..\\target\\common\\board_spi.h"
...
#line 99 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\crypto_qspi_aesb\\main.c"
#line 1 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\crypto_qspi_aesb\\..\\..\\drivers\\crypto/aesb.h"
...
#line 56 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\crypto_qspi_aesb\\..\\..\\drivers\\crypto/aesb.h"
...
#line 102 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\crypto_qspi_aesb\\main.c"
...
#line 103 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\crypto_qspi_aesb\\main.c"
...
#line 105 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\crypto_qspi_aesb\\main.c"
#line 1 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\crypto_qspi_aesb\\..\\..\\drivers\\serial/console.h"
...
#line 106 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\crypto_qspi_aesb\\main.c"
...
#line 108 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\crypto_qspi_aesb\\main.c"
...
int main(void)
{
	...
	pmc_configure_peripheral((10), 0, 1);
	...
	aesb_configure((0x1u << 2) | (0x1u << 3) | (((0xfu << 4) & ((0) << 4))) |
	               (0x1u << 8) | (0x4u << 12) | (0xEu << 20));

	printf("-I- Enable QSPI AESB IP scope (0x900000000-0x980000000)\n\r");
	spi_flash_use_aesb(flash, 1);

	 
	for (idx = 0; idx < (sizeof ((buffer)) / sizeof(*(buffer))); idx++)
		buffer[idx] = 1 << (idx % 8);

	if (spi_flash_erase(flash, 0, 4096) < 0)
		do { if (trace_level >= 1) printf("-F- " "QSPI Flash block erase failed!\n\r"); while (1) ; } while (0);

	printf("-I- Writing to address of QSPI AESB IP scope, the data is encrypted automatically\n\r");
	if (spi_flash_write(flash, 0, buffer, (sizeof ((buffer)) / sizeof(*(buffer)))) < 0)
		do { if (trace_level >= 1) printf("-F- " "QSPI Flash writing failed!\n\r"); while (1) ; } while (0);

	printf("-I- Read from address of QSPI AESB IP scope\n\r");
	memset(buffer_read, 0, (sizeof ((buffer_read)) / sizeof(*(buffer_read))));
	if (spi_flash_read(flash, 0, buffer_read, (sizeof ((buffer_read)) / sizeof(*(buffer_read)))) < 0)
			do { if (trace_level >= 1) printf("-F- " "Read the code from QSPI Flash failed!\n\r"); while (1) ; } while (0);
	verify_failed = 0;
	printf("-I- Read and verify data from address of AESB IP scope\r\n");
	for (idx = 0; idx < (sizeof ((buffer_read)) / sizeof(*(buffer_read))); idx++) {

...
{
	((source == (47)) ? (void) 0 : (__aeabi_assert("source == (47)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\crypto\\trng.c", 88), (__iar_EmptyStepPoint())));
	if (((Trng *)0xFC01C000U)->TRNG_ISR & (0x1u << 0)) {
		if (_trng_callback) {
			_trng_callback(((Trng *)0xFC01C000U)->TRNG_ODATA, _trng_callback_arg);
		}
	}
}
...
void trng_enable()
{
	pmc_enable_peripheral((47));
	((Trng *)0xFC01C000U)->TRNG_CR = (0x1u << 0) | (0x524E47u << 8);
}

void trng_disable()
{
	((Trng *)0xFC01C000U)->TRNG_CR = (0x524E47u << 8);
	pmc_disable_peripheral((47));
}
...
void trng_enable_it(trng_callback_t cb, void* user_arg)
{
	...
	irq_add_handler((47), _trng_handler, ((void*)0));
	irq_enable((47));
	((Trng *)0xFC01C000U)->TRNG_IER = (0x1u << 0);
}

void trng_disable_it(void)
{
	((Trng *)0xFC01C000U)->TRNG_IDR = (0x1u << 0);
	irq_disable((47));
...
{
	while (!(((Trng *)0xFC01C000U)->TRNG_ISR & (0x1u << 0)));
	return ((Trng *)0xFC01C000U)->TRNG_ODATA;
}

...
static const struct spi_flash_cfg _spi_flash_cfg[] = {

	{
		...
		.qspi = {
			.addr = ((Qspi *)0xF0024000U),
		},
	},
#line 81 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\target\\common\\board_spi.c"
	{ 0 },
};
...
void board_cfg_spi_bus(void)
{
	...
	const struct _pin pins_spi_bus0[] = { { 2, (1u << 28), 1, (0) }, { 2, (1u << 29), 1, (0) }, { 2, (1u << 30), 1, (0) }, { 2, (1u << 31), 1, (0) }, { 3, (1u << 0), 1, (0) } };
	const struct _bus_iface iface_bus0 = {
		.type = BUS_TYPE_SPI,
		.spi = {
			.hw = ((Spi *)0xFC018400U),
		},
		.transfer_mode = BUS_TRANSFER_MODE_POLLING,
	};
...
void board_cfg_spi_flash(void)
{
	...
	struct _pin pins_qspi[] = { { 1, 0x000007e0, 3, (1u << 0) },};

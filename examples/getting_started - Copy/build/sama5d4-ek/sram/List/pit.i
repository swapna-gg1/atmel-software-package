...
{
	uint32_t pit_frequency = pmc_get_peripheral_clock(( 3)) / 1000000;
	((Pit *)0xFC068630U)->PIT_MR = period ? (((period * pit_frequency)==0) ? 0 : ((((period * pit_frequency)<=0) ^ ((16)<=0)) ? (((period * pit_frequency)-(16)/2)/(16)) : (((period * pit_frequency)+(16)/2)/(16)))) : 0;
	((Pit *)0xFC068630U)->PIT_MR |= (0x1u << 24);
}

void pit_set_piv(uint32_t piv)
{
	uint32_t mr = ((Pit *)0xFC068630U)->PIT_MR & ~(0xfffffu << 0);
	((Pit *)0xFC068630U)->PIT_MR = mr | (((0xfffffu << 0) & ((piv) << 0)));
}
...
{
        irq_add_handler(( 3), _pit_handler, ((void*)0));
	irq_enable(( 3));
                
	((Pit *)0xFC068630U)->PIT_MR |= (0x1u << 25);
}
...
{
	return ((Pit *)0xFC068630U)->PIT_MR;
}

uint32_t pit_get_status(void)
{
	return ((Pit *)0xFC068630U)->PIT_SR;
}

uint32_t pit_get_piir(void)
{
	return ((Pit *)0xFC068630U)->PIT_PIIR;
}

uint32_t pit_get_pivr(void)
{
	return ((Pit *)0xFC068630U)->PIT_PIVR;
}

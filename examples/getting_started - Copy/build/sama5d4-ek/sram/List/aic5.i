...
void aic_initialize(aic_handler_t irq_handler)
{
	...
	_aic_initialize(((Aic *)0xFC06E000U), irq_handler);

	_aic_initialize(((Aic *)0xFC068400U), irq_handler);

	 
	uint32_t aicredir = (((0x7fffffffu << 1) & (((uint32_t)(0x2fb3d881u)) << 1)));
	((Sfr *)0xF8028000U)->SFR_AICREDIR = (aicredir ^ ((Sfr *)0xF8028000U)->SFR_SN1) | (0x1u << 0);
...
{
	((Aic *)0xFC06E000U)->AIC_SPU = (uint32_t)handler;

	if (((Sfr *)0xF8028000U)->SFR_AICREDIR == 0)
		((Aic *)0xFC068400U)->AIC_SPU = (uint32_t)handler;
...
{
	return ((Aic *)0xFC06E000U)->AIC_ISR;
}

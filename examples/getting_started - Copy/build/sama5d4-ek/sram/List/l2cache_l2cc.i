#line 1 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\mm\\l2cache_l2cc.c"
...
#line 35 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\mm\\l2cache_l2cc.c"
...
#line 36 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\mm\\l2cache_l2cc.c"
...
#line 38 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\mm\\l2cache_l2cc.c"
...
#line 39 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\mm\\l2cache_l2cc.c"
...
#line 41 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\mm\\l2cache_l2cc.c"
...
_Bool l2cache_is_enabled(void)
{
	return (((L2cc *)0x00A00000U)->L2CC_CR & (0x1u << 0)) != 0;
}
...
void l2cache_enable(void)
{
	...
	((L2cc *)0x00A00000U)->L2CC_CR |= (0x1u << 0);
	dsb();
	isb();
}
...
{
	((!l2cache_is_enabled()) ? (void) 0 : (__aeabi_assert("!l2cache_is_enabled()", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\mm\\l2cache_l2cc.c", 79), (__iar_EmptyStepPoint())));
	((L2cc *)0x00A00000U)->L2CC_ACR |= (0x1u << 12);
}

void l2cache_set_non_exclusive(void)
{
	((!l2cache_is_enabled()) ? (void) 0 : (__aeabi_assert("!l2cache_is_enabled()", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\mm\\l2cache_l2cc.c", 85), (__iar_EmptyStepPoint())));
	((L2cc *)0x00A00000U)->L2CC_ACR &= ~(0x1u << 12);
}

void l2cc_set_tag_ram_latency(const struct _l2cc_ram_latency *latency)
{
	((!l2cache_is_enabled()) ? (void) 0 : (__aeabi_assert("!l2cache_is_enabled()", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\mm\\l2cache_l2cc.c", 91), (__iar_EmptyStepPoint())));

	((L2cc *)0x00A00000U)->L2CC_TRCR = (((0x7u << 0) & ((latency->setup) << 0))) |
	                  (((0x7u << 4) & ((latency->read) << 4))) |
	                  (((0x7u << 8) & ((latency->write) << 8)));
};

void l2cc_set_data_ram_latency(const struct _l2cc_ram_latency *latency)
{
	((!l2cache_is_enabled()) ? (void) 0 : (__aeabi_assert("!l2cache_is_enabled()", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\mm\\l2cache_l2cc.c", 100), (__iar_EmptyStepPoint())));

	((L2cc *)0x00A00000U)->L2CC_DRCR = (((0x7u << 0) & ((latency->setup) << 0))) |
	                  (((0x7u << 4) & ((latency->read) << 4))) |
	                  (((0x7u << 8) & ((latency->write) << 8)));
}
...
{
	((cfg->offset <= 7 || cfg->offset == 15 || cfg->offset == 23 || cfg->offset == 31) ? (void) 0 : (__aeabi_assert("cfg->offset <= 7 || cfg->offset == 15 || cfg->offset == 23 || cfg->offset == 31", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\mm\\l2cache_l2cc.c", 112), (__iar_EmptyStepPoint())));



	((!l2cache_is_enabled()) ? (void) 0 : (__aeabi_assert("!l2cache_is_enabled()", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\mm\\l2cache_l2cc.c", 113), (__iar_EmptyStepPoint())));

	((L2cc *)0x00A00000U)->L2CC_ACR = (cfg->high_prior_so ? (0x1u << 10) : 0) |
	                 (cfg->store_buff_dev_limit ? (0x1u << 11) : 0) |
	                 (cfg->shared_attr_invalidate ? (0x1u << 13) : 0) |
	                 (cfg->evt_mon_bus ? (0x1u << 20) : 0) |
	                 (cfg->parity ? (0x1u << 21) : 0) |
	                 (cfg->shared_attr_override ? (0x1u << 22) : 0) |
	                 (((0x3u << 23) & ((cfg->force_write_alloc) << 23))) |
	                 (cfg->cache_replacement ? (0x1u << 25) : 0) |
	                 (cfg->non_sec_lockdown ? (0x1u << 26) : 0) |
	                 (cfg->it_acces_non_sec ? (0x1u << 27) : 0) |
	                 (cfg->data_prefetch ? (0x1u << 28) : 0) |
	                 (cfg->instruct_prefetch ? (0x1u << 29) : 0);

	((L2cc *)0x00A00000U)->L2CC_DCR = (cfg->no_cache_linefill ? (0x1u << 0) : 0) |
	                 (cfg->no_write_back ? (0x1u << 1) : 0);

	((L2cc *)0x00A00000U)->L2CC_PCR = (((0x1fu << 0) & ((cfg->offset) << 0))) |
	                 (cfg->exclusive_seq_same_id ? (0x1u << 21) : 0) |
	                 (cfg->incr_double_linefill ? (0x1u << 23) : 0) |
	                 (cfg->prefetch_drop ? (0x1u << 24) : 0) |
	                 (cfg->DLFWRDIS << 27) |
	                 (cfg->data_prefetch ? (0x1u << 28) : 0) |
	                 (cfg->instruct_prefetch ? (0x1u << 29) : 0) |
	                 (cfg->double_linefill ? (0x1u << 30) : 0);

	((L2cc *)0x00A00000U)->L2CC_POWCR = (cfg->standby_mode ? (0x1u << 0) : 0) |
	                   (cfg->dyn_clock_gating ? (0x1u << 1) : 0);
}

void l2cc_data_prefetch_enable(void)
{
	((L2cc *)0x00A00000U)->L2CC_PCR |= (0x1u << 28);
}

void l2cc_inst_prefetch_enable(void)
{
	((L2cc *)0x00A00000U)->L2CC_PCR |= (0x1u << 29);
}

void l2cc_enable_event_counter(uint8_t event_counter)
{
	((event_counter < 2) ? (void) 0 : (__aeabi_assert("event_counter < 2", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\mm\\l2cache_l2cc.c", 156), (__iar_EmptyStepPoint())));

	switch (event_counter) {
	case 0:
		((L2cc *)0x00A00000U)->L2CC_ECR = (0x1u << 0) | (0x1u << 1);
		break;
	case 1:
		((L2cc *)0x00A00000U)->L2CC_ECR = (0x1u << 0) | (0x1u << 2);
		break;
	default:
		break;
	}
...
{
	((event_counter < 2) ? (void) 0 : (__aeabi_assert("event_counter < 2", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\mm\\l2cache_l2cc.c", 172), (__iar_EmptyStepPoint())));
	((!l2cache_is_enabled()) ? (void) 0 : (__aeabi_assert("!l2cache_is_enabled()", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\mm\\l2cache_l2cc.c", 173), (__iar_EmptyStepPoint())));

	switch (event_counter) {
	case 0:
		((L2cc *)0x00A00000U)->L2CC_ECFGR0 = (source & (0xfu << 2)) |
		                    (it & (0x3u << 0));
		break;
	case 1:
		((L2cc *)0x00A00000U)->L2CC_ECFGR1 = (source & (0xfu << 2)) |
		                    (it & (0x3u << 0));
		break;
	default:
		break;
...
{
	((event_counter < 2) ? (void) 0 : (__aeabi_assert("event_counter < 2", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\mm\\l2cache_l2cc.c", 192), (__iar_EmptyStepPoint())));

	switch (event_counter) {
	case 0:
		return ((L2cc *)0x00A00000U)->L2CC_EVR0;
	case 1:
		return ((L2cc *)0x00A00000U)->L2CC_EVR1;
	default:
		return 0;
	}
}
...
{
	((L2cc *)0x00A00000U)->L2CC_IMR |= sources;
}
...
{
	return ((L2cc *)0x00A00000U)->L2CC_RISR & sources;
}

uint32_t l2cc_it_status_mask(uint32_t sources)
{
	return ((L2cc *)0x00A00000U)->L2CC_MISR & sources;
}

void l2cc_it_clear(uint32_t sources)
{
	((L2cc *)0x00A00000U)->L2CC_ICR |= sources;
}

_Bool l2cc_get_spniden()
{
	return (((L2cc *)0x00A00000U)->L2CC_DCR & (0x1u << 2)) != 0;
}

void l2cc_cache_sync()
{
	while (((L2cc *)0x00A00000U)->L2CC_CSR & (0x1u << 0)) {}
	((L2cc *)0x00A00000U)->L2CC_CSR = (0x1u << 0);
	while (((L2cc *)0x00A00000U)->L2CC_CSR & (0x1u << 0)) {}
}
...
void l2cc_invalidate_pal(uint32_t phys_addr)
{
	...
	tag = phys_addr >> (5 + 9);
	index = (phys_addr >> 5) & ((1 << 9) - 1);
	((L2cc *)0x00A00000U)->L2CC_IPALR = (((0x3ffffu << 14) & ((tag) << 14))) | (((0x1ffu << 5) & ((index) << 5))) | (0x1u << 0);
	while (((L2cc *)0x00A00000U)->L2CC_IPALR & (0x1u << 0)) {}
}
...
void l2cc_clean_pal(uint32_t phys_addr)
{
	...
	tag = phys_addr >> (5 + 9);
	index = (phys_addr >> 5) & ((1 << 9) - 1);
	((L2cc *)0x00A00000U)->L2CC_CPALR = (((0x3ffffu << 14) & ((tag) << 14))) | (((0x1ffu << 5) & ((index) << 5))) | (0x1u << 0);
	while (((L2cc *)0x00A00000U)->L2CC_CPALR & (0x1u << 0)) {}
}
...
void l2cc_clean_invalidate_pal(uint32_t phys_addr)
{
	...
	tag = phys_addr >> (5 + 9);
	index = (phys_addr >> 5) & ((1 << 9) - 1);
	((L2cc *)0x00A00000U)->L2CC_CIPALR = (((0x3ffffu << 14) & ((tag) << 14))) | (((0x1ffu << 5) & ((index) << 5))) | (0x1u << 0);
	while (((L2cc *)0x00A00000U)->L2CC_CIPALR & (0x1u << 0)) {}
}

void l2cc_invalidate_way(uint8_t way)
{
	((L2cc *)0x00A00000U)->L2CC_IWR = way;
	while (((L2cc *)0x00A00000U)->L2CC_IWR & way) {}
}

void l2cc_clean_way(uint8_t way)
{
	((L2cc *)0x00A00000U)->L2CC_CWR = way;
	while (((L2cc *)0x00A00000U)->L2CC_CWR & way) {}
}

void l2cc_clean_invalidate_way(uint8_t way)
{
	((L2cc *)0x00A00000U)->L2CC_CIWR = way;
	while (((L2cc *)0x00A00000U)->L2CC_CIWR & way) {}
}
...
void l2cc_clean_index(uint32_t phys_addr, uint8_t way)
{
	...
	index = (phys_addr >> 5) & ((1 << 9) - 1);
	((L2cc *)0x00A00000U)->L2CC_CIR = (((0x1ffu << 5) & ((index) << 5))) | (((0x7u << 28) & ((way) << 28))) | (0x1u << 0);
	while (((L2cc *)0x00A00000U)->L2CC_CIR & (0x1u << 0)) {}
}
...
void l2cc_clean_invalidate_index(uint32_t phys_addr, uint8_t way)
{
	...
	index = (phys_addr >> 5) & ((1 << 9) - 1);
	((L2cc *)0x00A00000U)->L2CC_CIIR = (((0x1ffu << 5) & ((index) << 5))) | (((0x7u << 28) & ((way) << 28))) | (0x1u << 0);
	while (((L2cc *)0x00A00000U)->L2CC_CIIR & (0x1u << 0)) {}
}

void l2cc_data_lockdown(uint8_t way)
{
	((L2cc *)0x00A00000U)->L2CC_DLKR = way;
	while (((L2cc *)0x00A00000U)->L2CC_CSR & (0x1u << 0)) {}
}

void l2cc_instruction_lockdown(uint8_t way)
{
	((L2cc *)0x00A00000U)->L2CC_ILKR = way;
	while (((L2cc *)0x00A00000U)->L2CC_CSR & (0x1u << 0)) {}
}
...
{
	((start < end) ? (void) 0 : (__aeabi_assert("start < end", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\mm\\l2cache_l2cc.c", 351), (__iar_EmptyStepPoint())));
...
{
	((start < end) ? (void) 0 : (__aeabi_assert("start < end", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\mm\\l2cache_l2cc.c", 364), (__iar_EmptyStepPoint())));
	uint32_t current = start & ~0x1f;
	if (l2cache_is_enabled()) {
		while (current <= end) {
...
{
	((start < end) ? (void) 0 : (__aeabi_assert("start < end", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\mm\\l2cache_l2cc.c", 377), (__iar_EmptyStepPoint())));
	uint32_t current = start & ~0x1f;
	if (l2cache_is_enabled()) {
		while (current <= end) {
...
{
	((!l2cache_is_enabled()) ? (void) 0 : (__aeabi_assert("!l2cache_is_enabled()", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\mm\\l2cache_l2cc.c", 390), (__iar_EmptyStepPoint())));

	l2cc_event_config(0, (0x2u << 2),
	                  (0x0u << 0));
	l2cc_event_config(1, (0x4u << 2),
	                  (0x0u << 0));

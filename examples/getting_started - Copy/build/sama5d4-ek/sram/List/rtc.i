...
#line 288 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\peripherals\\rtc.c"
	...
	((Rtc *)0xFC0686B0U)->RTC_MR = mr;
}

enum _rtc_mode rtc_get_mode(void)
{

	uint32_t mr = ((Rtc *)0xFC0686B0U)->RTC_MR;
...
{
	return (((Rtc *)0xFC0686B0U)->RTC_MR & (0x1u << 0)) ? RTC_HOUR_MODE_12 : RTC_HOUR_MODE_24;
}
...
void rtc_enable_it(uint32_t sources)
{
	...
	((Rtc *)0xFC0686B0U)->RTC_IER = sources;
}
...
void rtc_disable_it(uint32_t sources)
{
	...
	((Rtc *)0xFC0686B0U)->RTC_IDR = sources;
}
...
uint32_t rtc_set_time(struct _time *time)
{
	...
	if ((((Rtc *)0xFC0686B0U)->RTC_MR & (0x1u << 0)) == (0x1u << 0)) {
		if (time->hour > 12) {
			time->hour -= 12;
			ltime |= (0x1u << 22);
		}
	...
	while ((((Rtc *)0xFC0686B0U)->RTC_SR & (0x1u << 2)) != (0x1u << 2));
	 
	((Rtc *)0xFC0686B0U)->RTC_CR |= (0x1u << 0);
	while ((((Rtc *)0xFC0686B0U)->RTC_SR & (0x1u << 0)) != (0x1u << 0));
	((Rtc *)0xFC0686B0U)->RTC_SCCR = (0x1u << 0);
	((Rtc *)0xFC0686B0U)->RTC_TIMR = ltime;
	((Rtc *)0xFC0686B0U)->RTC_CR &= (uint32_t) (~(0x1u << 0));
	((Rtc *)0xFC0686B0U)->RTC_SCCR |= (0x1u << 2);
	return (uint32_t) (((Rtc *)0xFC0686B0U)->RTC_VER & (0x1u << 0));
}
...
void rtc_get_time(struct _time *time)
{
	...
	ltime = ((Rtc *)0xFC0686B0U)->RTC_TIMR;
	while (ltime != ((Rtc *)0xFC0686B0U)->RTC_TIMR) {
		ltime = ((Rtc *)0xFC0686B0U)->RTC_TIMR;
	}
...
uint32_t rtc_set_time_alarm(struct _time *time)
{
	...
	((Rtc *)0xFC0686B0U)->RTC_SCCR = (0x1u << 1);
	((Rtc *)0xFC0686B0U)->RTC_TIMALR = alarm;
	return (uint32_t) (((Rtc *)0xFC0686B0U)->RTC_VER & (0x1u << 2));
}
...
void rtc_get_date(struct _date *date)
{
	...
	do {
		ldate = ((Rtc *)0xFC0686B0U)->RTC_CALR;
	} while (ldate != ((Rtc *)0xFC0686B0U)->RTC_CALR);
...
uint32_t rtc_set_date(struct _date *date)
{
	...
	((Rtc *)0xFC0686B0U)->RTC_CR |= (0x1u << 1);
	while ((((Rtc *)0xFC0686B0U)->RTC_SR & (0x1u << 0)) != (0x1u << 0));
	((Rtc *)0xFC0686B0U)->RTC_SCCR = (0x1u << 0);
	((Rtc *)0xFC0686B0U)->RTC_CALR = ldate;
	((Rtc *)0xFC0686B0U)->RTC_CR &= (uint32_t) (~(0x1u << 1));
	((Rtc *)0xFC0686B0U)->RTC_SCCR |= (0x1u << 2);	 
	return (uint32_t) (((Rtc *)0xFC0686B0U)->RTC_VER & (0x1u << 1));
}
...
uint32_t rtc_set_date_alarm(struct _date *date)
{
	...
	((Rtc *)0xFC0686B0U)->RTC_CALALR = alarm;
	return (uint32_t) (((Rtc *)0xFC0686B0U)->RTC_VER & (0x1u << 3));
}
...
void rtc_clear_sccr(uint32_t mask)
{
	...
	mask &= (0x1u << 0) | (0x1u << 1) | (0x1u << 2) |
		(0x1u << 3) | (0x1u << 4);
	((Rtc *)0xFC0686B0U)->RTC_SCCR = mask;
}

uint32_t rtc_get_sr(uint32_t mask)
{
	return (((Rtc *)0xFC0686B0U)->RTC_SR) & mask;
}
...
void rtc_get_tamper_time(struct _time *time,  uint8_t reg_num)
{
	...
	ltime = ((Rtc *)0xFC0686B0U)->RTC_TS[reg_num].RTC_TSTR;
	while (ltime != ((Rtc *)0xFC0686B0U)->RTC_TS[reg_num].RTC_TSTR) {
		ltime = ((Rtc *)0xFC0686B0U)->RTC_TS[reg_num].RTC_TSTR;
	}
	 
	if (time->hour) {
		temp = (ltime & (0x3fu << 16)) >> 16;
		time->hour = (temp >> 4) * 10 + (temp & 0xfu);
		if ((ltime & (0x1u << 22)) == (0x1u << 22)) {
			time->hour += 12;
		}
	}
	...
	if (time->min) {
		temp = (ltime & (0x7fu << 8)) >> 8;
		time->min = (temp >> 4) * 10 + (temp & 0xfu);
	}
	 
	if (time->sec) {
		temp = (ltime & (0x7fu << 0)) >> 0;
		time->sec = (temp >> 4) * 10 + (temp & 0xfu);
	}
}
...
void rtc_get_tamper_date(struct _date *date, uint8_t reg_num)
{
	...
	ldate = ((Rtc *)0xFC0686B0U)->RTC_TS[reg_num].RTC_TSDR;
	while (ldate != ((Rtc *)0xFC0686B0U)->RTC_TS[reg_num].RTC_TSDR) {
		ldate = ((Rtc *)0xFC0686B0U)->RTC_TS[reg_num].RTC_TSDR;
	}
	 
	temp = (ldate & (0x7fu << 0)) >> 0;
	cent = (temp >> 4) * 10 + (temp & 0xfu);
	temp = (ldate & (0xffu << 8)) >> 8;
	date->year = (cent * 10 * 10) + (temp >> 4) * 10 + (temp & 0xfu);

	 
	temp = (ldate & (0x1fu << 16)) >> 16;
	date->month = (temp >> 4) * 10 + (temp & 0xfu);

	 
	temp = (ldate & (0x3fu << 24)) >> 24;
	date->day = (temp >> 4) * 10 + (temp & 0xfu);

	 
	date->week= ((ldate & (0x7u << 21)) >> 21);
}

uint32_t rtc_get_tamper_source(uint8_t reg_num)
{
	return ((Rtc *)0xFC0686B0U)->RTC_TS[reg_num].RTC_TSSR;
}

uint32_t rtc_get_tamper_event_counter(void)
{
	return (((Rtc *)0xFC0686B0U)->RTC_TS[0].RTC_TSTR & (0xfu << 24)) >> 24;
}

uint8_t rtc_is_tamper_occur_in_backup_mode(uint8_t reg_num)
{
	if (((Rtc *)0xFC0686B0U)->RTC_TS[reg_num].RTC_TSTR & (0x1u << 31)) {
		return 1;
	} else {
		return 0;
	}
...
void rtc_calibration(int32_t current_tempr)
{
	...
	for (i = 0; i < (sizeof ((ppm_lookup)) / sizeof(*(ppm_lookup))); i++) {
		if (ppm_lookup[i].tempr == current_tempr) {
			 
			mr = ((Rtc *)0xFC0686B0U)->RTC_MR & ~((0x7fu << 8) | (0x1u << 15) | (0x1u << 4));
			mr |= (((0x7fu << 8) & ((ppm_lookup[i]. correction) << 8)));
...
{
   uint32_t reg;
   reg = ((Rtc *)0xFC0686B0U)->RTC_CR;
   reg &= ~(0x3u << 8);
   reg |= mask;
   ((Rtc *)0xFC0686B0U)->RTC_CR = reg;
   return ((Rtc *)0xFC0686B0U)->RTC_CR;
}

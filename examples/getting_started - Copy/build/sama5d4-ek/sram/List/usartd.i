...
#line 393 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\getting_started\\..\\..\\drivers\\serial/usart.h"
...
#line 93 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\getting_started\\..\\..\\drivers\\serial/usartd.h"
...
static struct _usart_desc *_serial[(5)];
...
static int _usartd_dma_write_callback(void* arg, void* arg2)
{
	...
	((iface < (5)) ? (void) 0 : (__aeabi_assert("iface < (5)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\serial\\usartd.c", 69), (__iar_EmptyStepPoint())));
...
{
	uint8_t iface = (uint32_t)arg;
	((iface < (5)) ? (void) 0 : (__aeabi_assert("iface < (5)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\serial\\usartd.c", 83), (__iar_EmptyStepPoint())));
...
static void _usartd_dma_read(uint8_t iface)
{
	...
	((iface < (5)) ? (void) 0 : (__aeabi_assert("iface < (5)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\serial\\usartd.c", 114), (__iar_EmptyStepPoint())));
	struct _usart_desc* desc = _serial[iface];
...
{
	struct _callback _cb;
	((iface < (5)) ? (void) 0 : (__aeabi_assert("iface < (5)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\serial\\usartd.c", 134), (__iar_EmptyStepPoint())));
	struct _usart_desc* desc = _serial[iface];
	struct _dma_transfer_cfg cfg;
...
void usartd_configure(uint8_t iface, struct _usart_desc* config)
{
	...
	((id < (68)) ? (void) 0 : (__aeabi_assert("id < (68)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\serial\\usartd.c", 237), (__iar_EmptyStepPoint())));
	((iface < (5)) ? (void) 0 : (__aeabi_assert("iface < (5)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\serial\\usartd.c", 238), (__iar_EmptyStepPoint())));

	_serial[iface] = config;

#line 248 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\serial\\usartd.c"
...
#line 263 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\serial\\usartd.c"
...
{
	((iface < (5)) ? (void) 0 : (__aeabi_assert("iface < (5)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\serial\\usartd.c", 285), (__iar_EmptyStepPoint())));
	struct _usart_desc *desc = _serial[iface];
	uint8_t tmode;
	uint32_t csr;
	uint32_t i;
...
#line 352 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\serial\\usartd.c"
				{
...
#line 384 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\serial\\usartd.c"
				{
...
{
	((iface < (5)) ? (void) 0 : (__aeabi_assert("iface < (5)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\serial\\usartd.c", 440), (__iar_EmptyStepPoint())));
	mutex_unlock(&_serial[iface]->rx.mutex);
}

void usartd_finish_tx_transfer(uint8_t iface)
{
	((iface < (5)) ? (void) 0 : (__aeabi_assert("iface < (5)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\serial\\usartd.c", 446), (__iar_EmptyStepPoint())));
	mutex_unlock(&_serial[iface]->tx.mutex);
}

uint32_t usartd_rx_is_busy(const uint8_t iface)
{
	((iface < (5)) ? (void) 0 : (__aeabi_assert("iface < (5)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\serial\\usartd.c", 452), (__iar_EmptyStepPoint())));
	return mutex_is_locked(&_serial[iface]->rx.mutex);
}

uint32_t usartd_tx_is_busy(const uint8_t iface)
{
	((iface < (5)) ? (void) 0 : (__aeabi_assert("iface < (5)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\serial\\usartd.c", 458), (__iar_EmptyStepPoint())));
	return mutex_is_locked(&_serial[iface]->tx.mutex);
}

void usartd_wait_rx_transfer(const uint8_t iface)
{
	((iface < (5)) ? (void) 0 : (__aeabi_assert("iface < (5)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\serial\\usartd.c", 464), (__iar_EmptyStepPoint())));
	while (mutex_is_locked(&_serial[iface]->rx.mutex));
}

void usartd_wait_tx_transfer(const uint8_t iface)
{
	((iface < (5)) ? (void) 0 : (__aeabi_assert("iface < (5)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\serial\\usartd.c", 470), (__iar_EmptyStepPoint())));

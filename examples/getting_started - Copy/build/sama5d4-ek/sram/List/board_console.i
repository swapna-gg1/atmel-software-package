...
#line 108 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\target\\common\\chip_common.h"
...
void board_cfg_console(uint32_t baudrate)
{
	...
	console_cfg.addr = ((Usart *)0xFC00C000U);
	console_cfg.baudrate = baudrate;

	const struct _pin tx_pin = { 4, (1u << 17), 1, (0) };
	console_cfg.tx_pin = tx_pin;


	const struct _pin rx_pin = { 4, (1u << 16), 1, (0) };

#line 1 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\serial\\uart.c"
...
#line 35 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\serial\\uart.c"
...
#line 36 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\serial\\uart.c"
...
#line 37 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\serial\\uart.c"
...
#line 38 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\serial\\uart.c"
...
void uart_configure(Uart* uart, uint32_t mode, uint32_t baudrate)
{
	...
	uart->UART_CR = (0x1u << 4) | (0x1u << 6);
}



 
void uart_set_transmitter_enabled(Uart* uart, _Bool enabled)
{
	uart->UART_CR = enabled ? (0x1u << 6) : (0x1u << 7);
}



 
void uart_set_receiver_enabled(Uart* uart, _Bool enabled)
{
	uart->UART_CR = enabled ? (0x1u << 4) : (0x1u << 5);
}
...
_Bool uart_is_tx_ready(Uart* uart)
{
	return (uart->UART_SR & (0x1u << 1)) != 0;
}



 
_Bool uart_is_tx_empty(Uart* uart)
{
	return (uart->UART_SR & (0x1u << 9)) != 0;
}
...
_Bool uart_is_rx_ready(Uart* uart)
{
	return (uart->UART_SR & (0x1u << 0)) != 0;
}
...
{
	((uart != ((void*)0)) ? (void) 0 : (__aeabi_assert("uart != ((void*)0)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\serial\\uart.c", 158), (__iar_EmptyStepPoint())));
	return uart->UART_SR;
}
...
{
	uint32_t status;
	((uart != ((void*)0)) ? (void) 0 : (__aeabi_assert("uart != ((void*)0)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\serial\\uart.c", 165), (__iar_EmptyStepPoint())));
	status = uart->UART_SR;

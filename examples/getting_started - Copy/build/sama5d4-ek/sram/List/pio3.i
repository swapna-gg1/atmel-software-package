...
static Pio* _pio_get_instance(uint32_t group)
{
	...
	case 0:
		return ((Pio *)0xFC06A000U);


	case 1:
		return ((Pio *)0xFC06B000U);


	case 2:
		return ((Pio *)0xFC06C000U);


	case 3:
		return ((Pio *)0xFC068000U);


	case 4:
		return ((Pio *)0xFC06D000U);
...
static void _pio_handler(uint32_t source, void* user_arg)
{
	...
	if (group_mask & (1 << 0))
		_pio_handle_interrupt(0, ((Pio *)0xFC06A000U));


	if (group_mask & (1 << 1))
		_pio_handle_interrupt(1, ((Pio *)0xFC06B000U));


	if (group_mask & (1 << 2))
		_pio_handle_interrupt(2, ((Pio *)0xFC06C000U));


	if (group_mask & (1 << 3))
		_pio_handle_interrupt(3, ((Pio *)0xFC068000U));


	if (group_mask & (1 << 4))
		_pio_handle_interrupt(4, ((Pio *)0xFC06D000U));
...
void pio_configure(const struct _pin *pin_list, uint32_t size)
{
	...
	for (i = 0; i < size; i++) {
		...
		if (pin->attribute & (1u << 9))
			...
			do { if (trace_level >= 1) printf("-F- " "Invalid slew rate setting\r\n"); while (1) ; } while (0);

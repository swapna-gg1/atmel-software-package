...
{
	((dbgu == ((Dbgu *)0xFC069000U)) ? (void) 0 : (__aeabi_assert("dbgu == ((Dbgu *)0xFC069000U)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\serial\\dbgu.c", 65), (__iar_EmptyStepPoint())));
	...
	dbgu->DBGU_BRGR = (((pmc_get_peripheral_clock((45)) / 16)==0) ? 0 : ((((pmc_get_peripheral_clock((45)) / 16)<=0) ^ ((baudrate)<=0)) ? (((pmc_get_peripheral_clock((45)) / 16)-(baudrate)/2)/(baudrate)) : (((pmc_get_peripheral_clock((45)) / 16)+(baudrate)/2)/(baudrate))));

...
void smc_nand_configure(uint8_t bus_width)
{
	...
	pmc_configure_peripheral((22), ((void*)0), 1);


	((Smc *)0xFC05C600U)->SMC_CS[3].SMC_SETUP =
		(((0x3fu << 0) & ((2) << 0))) |
		(((0x3fu << 8) & ((2) << 8))) |
		(((0x3fu << 16) & ((2) << 16))) |
		(((0x3fu << 24) & ((2) << 24)));

	((Smc *)0xFC05C600U)->SMC_CS[3].SMC_PULSE =
		(((0x7fu << 0) & ((7) << 0))) |
		(((0x7fu << 8) & ((7) << 8))) |
		(((0x7fu << 16) & ((7) << 16))) |
		(((0x7fu << 24) & ((7) << 24)));

	((Smc *)0xFC05C600U)->SMC_CS[3].SMC_CYCLE =
		(((0x1ffu << 0) & ((13) << 0))) |
		(((0x1ffu << 16) & ((13) << 16)));


	((Smc *)0xFC05C600U)->SMC_CS[3].SMC_TIMINGS =
		(((0xfu << 0) & ((3) << 0))) |
		(((0xfu << 4) & ((27) << 4))) |
		(((0xfu << 8) & ((3) << 8))) |
		(((0xfu << 16) & ((6) << 16))) |
	...
	((Smc *)0xFC05C600U)->SMC_CS[3].SMC_MODE =
		(0x1u << 0) |
		(0x1u << 1) |
...
void smc_nor_configure(uint8_t cs, uint8_t bus_width)
{
	...
	((Smc *)0xFC05C600U)->SMC_CS[cs].SMC_SETUP =
		(((0x3fu << 0) & ((1) << 0))) |
		(((0x3fu << 8) & ((0) << 8))) |
		(((0x3fu << 16) & ((2) << 16))) |
		(((0x3fu << 24) & ((0) << 24)));

	((Smc *)0xFC05C600U)->SMC_CS[cs].SMC_PULSE =
		(((0x7fu << 0) & ((10) << 0))) |
		(((0x7fu << 8) & ((10) << 8))) |
		(((0x7fu << 16) & ((11) << 16))) |
		(((0x7fu << 24) & ((11) << 24)));

	((Smc *)0xFC05C600U)->SMC_CS[cs].SMC_CYCLE =
		(((0x1ffu << 0) & ((11) << 0))) |
		(((0x1ffu << 16) & ((14) << 16)));


	((Smc *)0xFC05C600U)->SMC_CS[cs].SMC_TIMINGS = 0;


	((Smc *)0xFC05C600U)->SMC_CS[cs].SMC_MODE =
		(0x1u << 0) |
		(0x1u << 1) |
		(bus_width == 8 ? (0x0u << 12) : (0x1u << 12)) |
		(0x0u << 4) |
...
{
	((Smc *)0xFC05C600U)->SMC_KEY1 = key1;
	((Smc *)0xFC05C600U)->SMC_KEY2 = key2;
}

void smc_scrambling_enable(void)
{
	((Smc *)0xFC05C600U)->SMC_OCMS |= (0x1u << 0);
}
...
_Bool smc_scrambling_is_enabled(void)
{
	return ((Smc *)0xFC05C600U)->SMC_OCMS & (0x1u << 0);
}

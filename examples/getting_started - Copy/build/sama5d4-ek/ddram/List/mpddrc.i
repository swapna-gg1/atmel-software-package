...
#line 79 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\extram\\mpddrc.c"
	((Mpddrc *)0xF0010000U)->MPDDRC_TPR0 = (((0xfu << 28) & ((desc->timings . tmrd) << 28)))
	                    | (((0xfu << 24) & ((desc->timings . twtr) << 24)))
	...
	((Mpddrc *)0xF0010000U)->MPDDRC_TPR1 = (((0xfu << 24) & ((desc->timings . txp) << 24)))
	...
	((Mpddrc *)0xF0010000U)->MPDDRC_TPR2 = (((0xfu << 16) & ((desc->timings . tfaw) << 16)))
...
#line 116 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\extram\\mpddrc.c"
	nc = ((((Mpddrc *)0xF0010000U)->MPDDRC_CR & (0x3u << 0)) >> 0) + 9;
	nr = ((((Mpddrc *)0xF0010000U)->MPDDRC_CR & (0x3u << 2)) >> 2) + 11;
	interleaved = (((Mpddrc *)0xF0010000U)->MPDDRC_CR & (0x1u << 22)) != 0;
	dbw16 = (((Mpddrc *)0xF0010000U)->MPDDRC_MD & (0x1u << 4)) != 0;
...
{
	((Mpddrc *)0xF0010000U)->MPDDRC_MR = cmd & (0x7u << 0);
	((Mpddrc *)0xF0010000U)->MPDDRC_MR;
	dmb();
...
{
	((Mpddrc *)0xF0010000U)->MPDDRC_MR = (0x5u << 0);
	((Mpddrc *)0xF0010000U)->MPDDRC_MR;
	dmb();
...
{
	((Mpddrc *)0xF0010000U)->MPDDRC_MR = (0x7u << 0) | (((0xffu << 8) & ((mrs) << 8)));
	((Mpddrc *)0xF0010000U)->MPDDRC_MR;
	dmb();
...
static void _configure_ddr2(struct _mpddrc_desc* desc)
{
	...
	((Mpddrc *)0xF0010000U)->MPDDRC_CR |= (0x1u << 7);
	...
	((Mpddrc *)0xF0010000U)->MPDDRC_CR |= (0x7u << 12);
...
#line 352 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\extram\\mpddrc.c"
...
#line 380 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\extram\\mpddrc.c"
}
...
extern void mpddrc_configure(struct _mpddrc_desc* desc)
{
	...
	pmc_configure_peripheral((16), ((void*)0), 1);

	pmc_enable_system_clock(PMC_SYSTEM_CLOCK_DDR);

	 
	((Mpddrc *)0xF0010000U)->MPDDRC_MD = desc->mode;


	 
	uint32_t value = ((Mpddrc *)0xF0010000U)->MPDDRC_IO_CALIBR;
	...
	((Mpddrc *)0xF0010000U)->MPDDRC_IO_CALIBR = value;



	((Mpddrc *)0xF0010000U)->MPDDRC_RD_DATA_PATH = desc->data_path;
	...
	((Mpddrc *)0xF0010000U)->MPDDRC_CR = desc->control;

	uint32_t lpr_prv = ((Mpddrc *)0xF0010000U)->MPDDRC_LPR, lpr = lpr_prv;

	lpr = (lpr & ~(0x1u << 16)) | (0x0u << 16);
#line 539 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\extram\\mpddrc.c"
	if (lpr != lpr_prv)
		((Mpddrc *)0xF0010000U)->MPDDRC_LPR = lpr;
...
#line 549 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\extram\\mpddrc.c"
	case MPDDRC_TYPE_DDR2:
		...
		break;
#line 564 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\extram\\mpddrc.c"
...
#line 573 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\extram\\mpddrc.c"
	...
	((Mpddrc *)0xF0010000U)->MPDDRC_RTR = (((0xfffu << 0) & ((desc->refresh_window * master_clock / desc->refresh_cycles) << 0)));
...
{
	uint32_t value;
	value = ((Mpddrc *)0xF0010000U)->MPDDRC_LPR & ~(0x3u << 0);
	((Mpddrc *)0xF0010000U)->MPDDRC_LPR = value | (cmd & (0x3u << 0));

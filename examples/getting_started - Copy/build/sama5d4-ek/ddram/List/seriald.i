...
extern _Bool l2cache_is_enabled(void);
...
#line 47 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\serial\\seriald.c"
...
extern void uart_set_transmitter_enabled(Uart* uart, _Bool enabled);
extern void uart_set_receiver_enabled (Uart* uart, _Bool enabled);
extern void uart_enable_it(Uart* uart, uint32_t mask);
extern void uart_disable_it(Uart* uart, uint32_t mask);
extern _Bool uart_is_tx_ready(Uart* uart);
extern _Bool uart_is_tx_empty(Uart* uart);
extern void uart_put_char(Uart* uart, uint8_t c);
extern _Bool uart_is_rx_ready(Uart* uart);
...
#line 131 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\serial\\seriald.c"
...
#line 187 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\serial\\seriald.c"
	if (!ops)
		return -(44);

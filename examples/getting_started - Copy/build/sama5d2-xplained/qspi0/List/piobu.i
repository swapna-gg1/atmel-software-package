#line 1 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\gpio\\piobu.c"
...
#line 35 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\gpio\\piobu.c"
...
#line 36 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\gpio\\piobu.c"
...
#line 38 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\gpio\\piobu.c"
#line 1 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\getting_started\\..\\..\\drivers\\gpio/piobu.h"
...
#line 39 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\getting_started\\..\\..\\drivers\\gpio/piobu.h"
...
#line 39 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\gpio\\piobu.c"
...
int piobu_configure(const struct _pin* pin_list, int size)
{
	...
	for (i = 0; i < size; i++) {
		...
		for (j = 0; j < (sizeof ((((Secumod *)0xFC040000U)->SECUMOD_PIOBU)) / sizeof(*(((Secumod *)0xFC040000U)->SECUMOD_PIOBU))); j++) {
			if (pin->mask & (1u << j))
				((Secumod *)0xFC040000U)->SECUMOD_PIOBU[j] = piobu;
		}
	}
...
uint32_t piobu_get(const struct _pin* pin)
{
	...
	for (i = 0; i < (sizeof ((((Secumod *)0xFC040000U)->SECUMOD_PIOBU)) / sizeof(*(((Secumod *)0xFC040000U)->SECUMOD_PIOBU))); i++) {
		if (pin->mask & (1u << i)) {
			if (((Secumod *)0xFC040000U)->SECUMOD_PIOBU[i] & (0x1u << 10))
				piobu |= (1u << i);
		}
	}
...
void piobu_set(const struct _pin* pin)
{
	...
	for (i = 0; i < (sizeof ((((Secumod *)0xFC040000U)->SECUMOD_PIOBU)) / sizeof(*(((Secumod *)0xFC040000U)->SECUMOD_PIOBU))); i++) {
		if (pin->mask & (1u << i))
			((Secumod *)0xFC040000U)->SECUMOD_PIOBU[i] |= (0x1u << 9);
	}
}

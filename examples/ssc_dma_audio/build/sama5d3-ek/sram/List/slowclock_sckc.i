...
{
	return (((Sckc *)0xFFFFFE50U)->SCKC_CR & (0x1u << 3)) != (0x1u << 3);
}
 ...
 void slowclock_select_internal(enum _slowclock_domain domain)
{
	...
	((Sckc *)0xFFFFFE50U)->SCKC_CR |= (0x1u << 0);
	...
	((Sckc *)0xFFFFFE50U)->SCKC_CR = (((Sckc *)0xFFFFFE50U)->SCKC_CR & ~(0x1u << 3)) | (0x0u << 3);
 ...
 void slowclock_select_external(enum _slowclock_domain domain)
{
	...
	((Sckc *)0xFFFFFE50U)->SCKC_CR = (((Sckc *)0xFFFFFE50U)->SCKC_CR & ~(0x1u << 3)) | (0x1u << 3);

	 
	for (count = 0; count < 0x1000; count++);


	if ((((Sckc *)0xFFFFFE50U)->SCKC_CR & (0x1u << 0)) == (0x1u << 0))
		((Sckc *)0xFFFFFE50U)->SCKC_CR &= ~(0x1u << 0);

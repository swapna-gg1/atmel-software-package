...
#line 126 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\examples\\ssc_dma_audio\\..\\..\\drivers\\nvm/i2c/at24.h"
...
void board_cfg_twi_bus(void)
{
	...
	const struct _pin pins_twi_bus0[] = { { 2, (1u << 26), 1, (0) }, { 2, (1u << 27), 1, (0) } };
	pio_configure(pins_twi_bus0, (sizeof ((pins_twi_bus0)) / sizeof(*(pins_twi_bus0))));
	iface.i2c.hw = ((Twi *)0xF0018000U);
	iface.i2c.freq = 300000;

...
{
	return *(volatile uint32_t*)((0x70000000u));
}

static void _nfc_write_cmd(uint32_t cmd, uint32_t value)
{
	*(volatile uint32_t*)((0x70000000u) + cmd) = value;
}
		...
		_Bool read_spare, _Bool write_spare)
{
	...
	((Nfc *)0xFFFFC000U)->NFC_CFG = cfg;
}

void nfc_enable(void)
{
	((Nfc *)0xFFFFC000U)->NFC_CTRL |= (0x1u << 0);
}

void nfc_disable(void)
{
	((Nfc *)0xFFFFC000U)->NFC_CTRL |= (0x1u << 1);
}

uint32_t nfc_get_status(void)
{
	return ((Nfc *)0xFFFFC000U)->NFC_SR;
}
...
{
	while ((((Nfc *)0xFFFFC000U)->NFC_SR & (0x1u << 17)) != (0x1u << 17));
}
...
{
	while ((((Nfc *)0xFFFFC000U)->NFC_SR & (0x1u << 16)) != (0x1u << 16));
}
...
{
	while ((((Nfc *)0xFFFFC000U)->NFC_SR & (0x1u << 24)) != (0x1u << 24));
}
...
void nfc_send_cmd(uint32_t cmd, uint8_t *cycle_bytes)
{
	...
	switch (cmd & (0x7u << 19)) {
	case (0x5u << 19):
		((Nfc *)0xFFFFC000U)->NFC_ADDR = cycle_bytes[0];
		cycle_offset = 1;
...
{
	((Smc *)0xFFFFC600U)->SMC_OCMS |= (0x1u << 1);
}
...
{
	return ((Smc *)0xFFFFC600U)->SMC_OCMS & (0x1u << 1);
}

...
static void _init_mt47h128m16(struct _mpddrc_desc* desc)
{
	...
	desc->timings.trfc   = ((((186) * (mck)) + 999) / 1000); 
	desc->timings.txsnr  = ((((208) * (mck)) + 999) / 1000); 
	desc->timings.txsrd  = 202;                 
	desc->timings.txp    = 3;                   
	desc->timings.txard  = 3;                   
	desc->timings.txards = 10;                  
...
{
	switch(device) {
#line 1062 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\extram\\ddram.c"
	case MT47H128M16:

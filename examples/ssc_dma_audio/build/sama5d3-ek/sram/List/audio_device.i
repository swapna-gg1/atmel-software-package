...
#line 45 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\audio_device.h"
...
struct _audio_desc {
	...
	union {
		uint32_t dummy;  
#line 127 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\audio_device.h"
		struct {
			Ssc *addr;
...
#line 73 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\audio_device.c"
...
{
	switch (desc->type) {
#line 149 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\audio_device.c"
...
{
	switch (desc->type) {
#line 184 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\audio_device.c"
	case AUDIO_DEVICE_SSC:
...
void audio_mute(struct _audio_desc *desc, _Bool mute)
{
	if (mute) {
		switch (desc->type) {
#line 230 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\audio_device.c"
		case AUDIO_DEVICE_SSC:
			switch (desc->device.ssc.codec->type) {

			case AUDIO_CODEC_WM8904:
				wm8904_volume_mute(&desc->device.ssc.codec->wm8904, 1, 1);
				break;
#line 247 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\audio_device.c"
		...
		switch (desc->type) {
#line 263 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\audio_device.c"
		case AUDIO_DEVICE_SSC:
			switch (desc->device.ssc.codec->type) {

			case AUDIO_CODEC_WM8904:
				wm8904_volume_mute(&desc->device.ssc.codec->wm8904, 0, 0);
				break;
...
void audio_set_volume(struct _audio_desc *desc, uint8_t vol)
{
	...
	if (vol <= (100)) {
		switch (desc->type) {
#line 309 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\audio_device.c"
...
{
	switch (desc->type) {
#line 360 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\audio_device.c"
	case AUDIO_DEVICE_SSC:
		switch (desc->direction) {
		case AUDIO_DEVICE_PLAY:
...
{
	switch (desc->type) {
#line 406 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\audio\\audio_device.c"
	case AUDIO_DEVICE_SSC:
		switch (desc->direction) {
		case AUDIO_DEVICE_PLAY:
			{

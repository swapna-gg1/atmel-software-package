...
#line 79 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\extram\\mpddrc.c"
	((Mpddrc *)0xFFFFEA00U)->MPDDRC_TPR0 = (((0xfu << 28) & ((desc->timings . tmrd) << 28)))
	...
	((Mpddrc *)0xFFFFEA00U)->MPDDRC_TPR1 = (((0xfu << 24) & ((desc->timings . txp) << 24)))
	                    | (((0xffu << 16) & ((desc->timings . txsrd) << 16)))
	                    | (((0xffu << 8) & ((desc->timings . txsnr) << 8)))
	                    | (((0x1fu << 0) & ((desc->timings . trfc) << 0)));





	((Mpddrc *)0xFFFFEA00U)->MPDDRC_TPR2 = (((0xfu << 16) & ((desc->timings . tfaw) << 16)))
...
#line 116 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\extram\\mpddrc.c"
	nc = ((((Mpddrc *)0xFFFFEA00U)->MPDDRC_CR & (0x3u << 0)) >> 0) + 9;
	nr = ((((Mpddrc *)0xFFFFEA00U)->MPDDRC_CR & (0x3u << 2)) >> 2) + 11;
	interleaved = (((Mpddrc *)0xFFFFEA00U)->MPDDRC_CR & (0x1u << 22)) != 0;
	dbw16 = (((Mpddrc *)0xFFFFEA00U)->MPDDRC_MD & (0x1u << 4)) != 0;
...
{
	((Mpddrc *)0xFFFFEA00U)->MPDDRC_MR = cmd & (0x7u << 0);
	((Mpddrc *)0xFFFFEA00U)->MPDDRC_MR;
	dmb();
...
{
	((Mpddrc *)0xFFFFEA00U)->MPDDRC_MR = (0x5u << 0);
	((Mpddrc *)0xFFFFEA00U)->MPDDRC_MR;
	dmb();
...
{
	((Mpddrc *)0xFFFFEA00U)->MPDDRC_MR = (0x7u << 0) | (((0xffu << 8) & ((mrs) << 8)));
	((Mpddrc *)0xFFFFEA00U)->MPDDRC_MR;
	dmb();
...
static void _configure_ddr2(struct _mpddrc_desc* desc)
{
	...
	((Mpddrc *)0xFFFFEA00U)->MPDDRC_CR |= (0x1u << 7);
	...
	((Mpddrc *)0xFFFFEA00U)->MPDDRC_CR |= (0x7u << 12);
...
extern void mpddrc_configure(struct _mpddrc_desc* desc)
{
	...
	((Mpddrc *)0xFFFFEA00U)->MPDDRC_MD = desc->mode;


	 
	uint32_t value = ((Mpddrc *)0xFFFFEA00U)->MPDDRC_IO_CALIBR;
	...
	((Mpddrc *)0xFFFFEA00U)->MPDDRC_IO_CALIBR = value;
	...
	((Mpddrc *)0xFFFFEA00U)->MPDDRC_CR = desc->control;

	uint32_t lpr_prv = ((Mpddrc *)0xFFFFEA00U)->MPDDRC_LPR, lpr = lpr_prv;

	lpr = (lpr & ~(0x1u << 16)) | (0x0u << 16);
#line 539 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\extram\\mpddrc.c"
	if (lpr != lpr_prv)
		((Mpddrc *)0xFFFFEA00U)->MPDDRC_LPR = lpr;
...
#line 573 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\extram\\mpddrc.c"
	...
	((Mpddrc *)0xFFFFEA00U)->MPDDRC_RTR = (((0xfffu << 0) & ((desc->refresh_window * master_clock / desc->refresh_cycles) << 0)));
...
{
	uint32_t value;
	value = ((Mpddrc *)0xFFFFEA00U)->MPDDRC_LPR & ~(0x3u << 0);
	((Mpddrc *)0xFFFFEA00U)->MPDDRC_LPR = value | (cmd & (0x3u << 0));

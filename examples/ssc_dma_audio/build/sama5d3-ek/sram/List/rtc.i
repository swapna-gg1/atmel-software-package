...
{
	return (((Rtc *)0xFFFFFEB0U)->RTC_MR & (0x1u << 0)) ? RTC_HOUR_MODE_12 : RTC_HOUR_MODE_24;
}
...
void rtc_enable_it(uint32_t sources)
{
	...
	(((sources & (uint32_t)(~((0x1u << 0) | (0x1u << 1) | (0x1u << 2) | (0x1u << 3) | (0x1u << 4) | 0))) == 0) ? (void) 0 : (__aeabi_assert("(sources & (uint32_t)(~((0x1u << 0) | (0x1u << 1) | (0x1u << 2) | (0x1u << 3) | (0x1u << 4) | 0))) == 0", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\peripherals\\rtc.c", 336), (__iar_EmptyStepPoint())));

	((Rtc *)0xFFFFFEB0U)->RTC_IER = sources;
}
...
void rtc_disable_it(uint32_t sources)
{
	...
	(((sources & (uint32_t)(~((0x1u << 0) | (0x1u << 1) | (0x1u << 2) | (0x1u << 3) | (0x1u << 4) | 0))) == 0) ? (void) 0 : (__aeabi_assert("(sources & (uint32_t)(~((0x1u << 0) | (0x1u << 1) | (0x1u << 2) | (0x1u << 3) | (0x1u << 4) | 0))) == 0", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\peripherals\\rtc.c", 346), (__iar_EmptyStepPoint())));

	((Rtc *)0xFFFFFEB0U)->RTC_IDR = sources;
}
...
uint32_t rtc_set_time(struct _time *time)
{
	...
	if ((((Rtc *)0xFFFFFEB0U)->RTC_MR & (0x1u << 0)) == (0x1u << 0)) {
		if (time->hour > 12) {
			time->hour -= 12;
			ltime |= (0x1u << 22);
		}
	...
	while ((((Rtc *)0xFFFFFEB0U)->RTC_SR & (0x1u << 2)) != (0x1u << 2));
	 
	((Rtc *)0xFFFFFEB0U)->RTC_CR |= (0x1u << 0);
	while ((((Rtc *)0xFFFFFEB0U)->RTC_SR & (0x1u << 0)) != (0x1u << 0));
	((Rtc *)0xFFFFFEB0U)->RTC_SCCR = (0x1u << 0);
	((Rtc *)0xFFFFFEB0U)->RTC_TIMR = ltime;
	((Rtc *)0xFFFFFEB0U)->RTC_CR &= (uint32_t) (~(0x1u << 0));
	((Rtc *)0xFFFFFEB0U)->RTC_SCCR |= (0x1u << 2);
	return (uint32_t) (((Rtc *)0xFFFFFEB0U)->RTC_VER & (0x1u << 0));
}
...
void rtc_get_time(struct _time *time)
{
	...
	ltime = ((Rtc *)0xFFFFFEB0U)->RTC_TIMR;
	while (ltime != ((Rtc *)0xFFFFFEB0U)->RTC_TIMR) {
		ltime = ((Rtc *)0xFFFFFEB0U)->RTC_TIMR;
	}
...
uint32_t rtc_set_time_alarm(struct _time *time)
{
	...
	((Rtc *)0xFFFFFEB0U)->RTC_SCCR = (0x1u << 1);
	((Rtc *)0xFFFFFEB0U)->RTC_TIMALR = alarm;
	return (uint32_t) (((Rtc *)0xFFFFFEB0U)->RTC_VER & (0x1u << 2));
}
...
void rtc_get_date(struct _date *date)
{
	...
	do {
		ldate = ((Rtc *)0xFFFFFEB0U)->RTC_CALR;
	} while (ldate != ((Rtc *)0xFFFFFEB0U)->RTC_CALR);
...
uint32_t rtc_set_date(struct _date *date)
{
	...
	((Rtc *)0xFFFFFEB0U)->RTC_CR |= (0x1u << 1);
	while ((((Rtc *)0xFFFFFEB0U)->RTC_SR & (0x1u << 0)) != (0x1u << 0));
	((Rtc *)0xFFFFFEB0U)->RTC_SCCR = (0x1u << 0);
	((Rtc *)0xFFFFFEB0U)->RTC_CALR = ldate;
	((Rtc *)0xFFFFFEB0U)->RTC_CR &= (uint32_t) (~(0x1u << 1));
	((Rtc *)0xFFFFFEB0U)->RTC_SCCR |= (0x1u << 2);	 
	return (uint32_t) (((Rtc *)0xFFFFFEB0U)->RTC_VER & (0x1u << 1));
}
...
uint32_t rtc_set_date_alarm(struct _date *date)
{
	...
	((Rtc *)0xFFFFFEB0U)->RTC_CALALR = alarm;
	return (uint32_t) (((Rtc *)0xFFFFFEB0U)->RTC_VER & (0x1u << 3));
}
...
void rtc_clear_sccr(uint32_t mask)
{
	...
	mask &= (0x1u << 0) | (0x1u << 1) | (0x1u << 2) |
		(0x1u << 3) | (0x1u << 4);
	((Rtc *)0xFFFFFEB0U)->RTC_SCCR = mask;
}

uint32_t rtc_get_sr(uint32_t mask)
{
	return (((Rtc *)0xFFFFFEB0U)->RTC_SR) & mask;
}
...
{
   uint32_t reg;
   reg = ((Rtc *)0xFFFFFEB0U)->RTC_CR;
   reg &= ~(0x3u << 8);
   reg |= mask;
   ((Rtc *)0xFFFFFEB0U)->RTC_CR = reg;
   return ((Rtc *)0xFFFFFEB0U)->RTC_CR;
}

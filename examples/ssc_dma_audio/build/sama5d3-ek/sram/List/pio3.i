...
static void _pio_handler(uint32_t source, void* user_arg)
{
	...
	if (group_mask & (1 << 0))
		_pio_handle_interrupt(0, ((Pio *)0xFFFFF200U));


	if (group_mask & (1 << 1))
		_pio_handle_interrupt(1, ((Pio *)0xFFFFF400U));


	if (group_mask & (1 << 2))
		_pio_handle_interrupt(2, ((Pio *)0xFFFFF600U));


	if (group_mask & (1 << 3))
		_pio_handle_interrupt(3, ((Pio *)0xFFFFF800U));


	if (group_mask & (1 << 4))
		_pio_handle_interrupt(4, ((Pio *)0xFFFFFA00U));

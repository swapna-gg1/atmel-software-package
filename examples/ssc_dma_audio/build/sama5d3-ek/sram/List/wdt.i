...
{
	((Wdt *)0xFFFFFE40U)->WDT_MR = (0x1u << 15);
}

void wdt_restart()
{
	((Wdt *)0xFFFFFE40U)->WDT_CR = (0xA5u << 24) | (0x1u << 0);
}
...
uint32_t wdt_get_status(void)
{
	...
	return ((Wdt *)0xFFFFFE40U)->WDT_SR & ((0x1u << 0) | (0x1u << 1));
...
uint32_t wdt_get_counter_value(void)
{
	...
	return (((Wdt *)0xFFFFFE40U)->WDT_MR & (0xfffu << 0)) >> 0;

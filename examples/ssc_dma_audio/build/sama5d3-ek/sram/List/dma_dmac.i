#line 1 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\dma\\dma_dmac.c"
...
#line 35 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\dma\\dma_dmac.c"
...
#line 37 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\dma\\dma_dmac.c"
...
#line 38 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\dma\\dma_dmac.c"
...
#line 40 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\dma\\dma_dmac.c"
...
#line 41 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\dma\\dma_dmac.c"
...
#line 42 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\dma\\dma_dmac.c"



 

#line 53 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\dma\\dma_dmac.c"
...
int dma_prepare_channel(struct _dma_channel* channel)
{
	...
	pmc_configure_peripheral(get_dmac_id_from_addr(dmac), ((void*)0), 1);
			     ...
			     struct _dmac_desc* desc)
{
	...
	cfg->cfg &= ~((0xfu << 0) | (0x3u << 10) |
	              (0xfu << 4) | (0x3u << 14));

	if ((ctrlb & (0x7u << 21)) == (0x2u << 21)) {
		cfg->cfg |= (((0xfu << 0) & ((channel->src_rxif) << 0)));
		cfg->cfg |= (((0x3u << 10) & ((channel->src_rxif >> 4) << 10)));
	}

	if ((ctrlb & (0x7u << 21)) == (0x1u << 21)) {
		cfg->cfg |= (((0xfu << 4) & ((channel->dest_txif) << 4)));
		cfg->cfg |= (((0x3u << 14) & ((channel->dest_txif >> 4) << 14)));
	}
...
void dma_irq_handler(uint32_t source, void* user_arg)
{
	...
	for (chan = 0; chan < (sizeof ((((Dmac*)0)->DMAC_CH)) / sizeof(*(((Dmac*)0)->DMAC_CH))); chan++) {
		struct _dma_channel* channel = &ctrl->channels[chan];
		_Bool exec = 0;
		if (!(gis & (((0x1u << 0) | (0x1u << 8) | (0x1u << 16)) << chan)))
			continue;
		if (channel->state == DMA_STATE_FREE)
			continue;
		if (gis & ((0x1u << 8) << chan)) {

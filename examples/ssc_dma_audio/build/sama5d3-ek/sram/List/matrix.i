...
void matrix_remap_rom(void)
{
	...
	((Matrix *)0xFFFFEC00U)->MATRIX_MRCR = 0;
	((Aximx *)0x00800000U)->AXIMX_REMAP = 0;
	...
	cache_invalidate_region((void*)0, ((0x10000u)+(0x10000u)));
}
...
void matrix_remap_ram(void)
{
	...
	((Matrix *)0xFFFFEC00U)->MATRIX_MRCR = (0x1u << 0);
	((Aximx *)0x00800000U)->AXIMX_REMAP = (0x1u << 0);
	...
	cache_clean_region((void*)(0x00300000u), ((0x10000u)+(0x10000u)));
	cache_invalidate_region((void*)0, ((0x10000u)+(0x10000u)));
}

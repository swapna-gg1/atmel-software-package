		      ...
		      uint32_t spi_mode)
{
	...
	((id < (79)) ? (void) 0 : (__aeabi_assert("id < (79)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\spi\\spi.c", 177), (__iar_EmptyStepPoint())));
...
void spi_set_cs_bitrate(Spi * spi, uint8_t cs, uint32_t bitrate)
{
	...
	uint32_t id = get_spi_id_from_addr(spi);
	((id < (79)) ? (void) 0 : (__aeabi_assert("id < (79)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\spi\\spi.c", 191), (__iar_EmptyStepPoint())));
...
{
	((spi != ((void*)0)) ? (void) 0 : (__aeabi_assert("spi != ((void*)0)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\spi\\spi.c", 242), (__iar_EmptyStepPoint())));

	 
	spi->SPI_FMR = (((0x3fu << 16) & ((tx_thres) << 16))) | (((0x3fu << 24) & ((rx_thres) << 24)))
		| (0x0u << 4) | (0x0u << 0);
}

void spi_fifo_enable(Spi *spi)
{
	((spi != ((void*)0)) ? (void) 0 : (__aeabi_assert("spi != ((void*)0)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\spi\\spi.c", 251), (__iar_EmptyStepPoint())));

	spi->SPI_CR = (0x1u << 1);
	spi->SPI_CR = (0x1u << 30) | (0x1u << 16) | (0x1u << 17);
...
{
	((spi != ((void*)0)) ? (void) 0 : (__aeabi_assert("spi != ((void*)0)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\spi\\spi.c", 261), (__iar_EmptyStepPoint())));

	spi->SPI_CR = (0x1u << 1);
	spi->SPI_CR = (0x1u << 31) | (0x1u << 16) | (0x1u << 17);
...
{
	((spi != ((void*)0)) ? (void) 0 : (__aeabi_assert("spi != ((void*)0)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\spi\\spi.c", 271), (__iar_EmptyStepPoint())));

	return (spi->SPI_FLR & (0x3fu << 16)) >> 16;
}

uint32_t spi_fifo_get_tx_size(Spi *spi)
{
	((spi != ((void*)0)) ? (void) 0 : (__aeabi_assert("spi != ((void*)0)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\spi\\spi.c", 278), (__iar_EmptyStepPoint())));

	return (spi->SPI_FLR & (0x3fu << 0)) >> 0;
}

void spi_fifo_flush_rx(Spi *spi)
{
	((spi != ((void*)0)) ? (void) 0 : (__aeabi_assert("spi != ((void*)0)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\spi\\spi.c", 285), (__iar_EmptyStepPoint())));
	spi->SPI_CR = (0x1u << 17);
}

void spi_fifo_flush_tx(Spi *spi)
{
	((spi != ((void*)0)) ? (void) 0 : (__aeabi_assert("spi != ((void*)0)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\spi\\spi.c", 291), (__iar_EmptyStepPoint())));
	spi->SPI_CR = (0x1u << 16);
}

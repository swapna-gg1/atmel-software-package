...
#line 135 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\peripherals\\matrix.c"
	((Aximx *)0x00600000U)->AXIMX_REMAP = 0;
...
#line 158 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\peripherals\\matrix.c"
	((Aximx *)0x00600000U)->AXIMX_REMAP = (0x1u << 0);
...
void matrix_set_default_config(void)
{
	...
	for (m_id = 0; m_id < 12; m_id++)
		matrix_configure_master(((Matrix *)0xF0018000U), m_id, (0x4u << 0));

	for (s_id = 0; s_id < 15; s_id++) {
		matrix_configure_slave(((Matrix *)0xF0018000U), s_id, (((0xfu << 18) & ((0) << 18))) |
			(0x0u << 16) | (0x1ffu << 0));
		for (m_id = 0; m_id < 12; m_id++)
			matrix_master_priority_for_slave(((Matrix *)0xF0018000U), s_id, m_id, 0);
		matrix_configure_slave_sec(((Matrix *)0xF0018000U), s_id, 0xFF, 0xFF, 0xFF);
	}
	...
	for (m_id = 0; m_id <= 8; m_id++)
		matrix_configure_master(((Matrix *)0xFC03C000U), m_id, (0x4u << 0));

	for (s_id = 0; s_id <= 6; s_id++) {
		matrix_configure_slave(((Matrix *)0xFC03C000U), s_id, (((0xfu << 18) & ((0) << 18))) |
			(0x0u << 16) | (0x1ffu << 0));
		for (m_id = 0; m_id <= 8; m_id++)
			matrix_master_priority_for_slave(((Matrix *)0xFC03C000U), s_id, m_id, 0);
		matrix_configure_slave_sec(((Matrix *)0xFC03C000U), s_id, 0xFF, 0xFF, 0xFF);
	}
}

#line 1 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\security\\secumod.c"
...
#line 1 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\security\\secumod.h"
...
#line 45 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\security\\secumod.h"
...
#line 46 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\security\\secumod.h"
...
#line 48 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\security\\secumod.h"
...
#line 49 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\security\\secumod.h"
...
extern void secumod_set_auto_backup(_Bool enable);




 
extern void secumod_set_scrambling(_Bool enable);
...
extern void secumod_set_jtag_protection(_Bool force_reset, uint8_t debug_permissions,
		_Bool ack_monitoring);
...
extern void secumod_periodic_alarm(_Bool enable);
...
#line 101 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\security\\secumod.c"
...
#line 103 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\security\\secumod.c"
...
#line 104 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\security\\secumod.c"
...
#line 105 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\security\\secumod.c"
...
#line 108 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\security\\secumod.c"
...
#line 110 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\security\\secumod.c"
...
#line 111 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\security\\secumod.c"
...
static void securam_irq_handler(uint32_t source, void* user_arg)
{
	...
	((source == (51)) ? (void) 0 : (__aeabi_assert("source == (51)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\security\\secumod.c", 150), (__iar_EmptyStepPoint())));
	...
	status = ((Secumod *)0xFC040000U)->SECUMOD_RAMACCSR;

	for (i = 0; i < 6; i++)
	{
		tmp = (status >> (2 * i)) & 3;
		if (tmp != ( 0x0u ) && secumod_inst.access_callback)
			secumod_inst.access_callback(i, tmp);
	}

	 
	do {
		status = ((Secumod *)0xFC040000U)->SECUMOD_SYSR;
	} while (status & (0x1u << 1));

	if ((0x1u << 0) == (status & (0x1u << 0)))
	{
		 
		((Secumod *)0xFC040000U)->SECUMOD_SYSR = (0x1u << 0);
	...
	while ((1000000 / pmc_get_slow_clock()) >=
			((pit_get_piir() & (0xfffu << 20)) >> 20));

	 
	((Secumod *)0xFC040000U)->SECUMOD_RAMACCSR = status;
...
static void secumod_irq_handler(uint32_t source, void* user_arg)
{
	...
	((source == (16)) ? (void) 0 : (__aeabi_assert("source == (16)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\security\\secumod.c", 207), (__iar_EmptyStepPoint())));
	...
	secumod_inst.tamper_info.jtag_sel_ca5 = 0;
	secumod_inst.tamper_info.jtag_tck_tms = 0;

	 
	if (status & (0x1u << 3)) {
		uint32_t jtag = ((Secumod *)0xFC040000U)->SECUMOD_ASR;
		secumod_inst.tamper_info.jtag_sel_ca5 = (jtag & (0x1u << 4)) != 0;
		secumod_inst.tamper_info.jtag_tck_tms = (jtag & (0x1u << 5)) != 0;
	}
...
void secumod_initialize(void)
{
	...
	irq_add_handler((16), secumod_irq_handler, ((void*)0));
	irq_add_handler((51), securam_irq_handler, ((void*)0));
}
...
{
	((Secumod *)0xFC040000U)->SECUMOD_CR = (0x1u << 0);
}
...
{
	((Secumod *)0xFC040000U)->SECUMOD_CR = (0x1u << 1);
}
...
{
	((Secumod *)0xFC040000U)->SECUMOD_CR = (0x1u << 2);
}
...
void secumod_set_auto_backup(_Bool enable)
{
	if (enable)
		((Secumod *)0xFC040000U)->SECUMOD_CR = (0x1u << 3);
	else
		((Secumod *)0xFC040000U)->SECUMOD_CR = (0x2u << 3);
}
...
void secumod_set_scrambling(_Bool enable)
{
	if (enable)
		((Secumod *)0xFC040000U)->SECUMOD_CR = (0x1u << 3);
	else
...
{
	((Secumod *)0xFC040000U)->SECUMOD_CR = ((((0xffffu << 16) & ((0x89CAu) << 16))));
}
...
{
	return ((Secumod *)0xFC040000U)->SECUMOD_SYSR;
}
...
{
	((Secumod *)0xFC040000U)->SECUMOD_SYSR = status;
}
...
{
	return ((Secumod *)0xFC040000U)->SECUMOD_SR;
}
...
{
	((Secumod *)0xFC040000U)->SECUMOD_SCR = status;
}
...
void secumod_piobu_config(struct _secumod_piobu *list, uint32_t size)
{
	...
	for (uwI = 0; uwI < size; uwI++) {
		...
		if (pBiobu->dynamic) {
		    ...
		    dwTmp = (pBiobu->afv << 0 ) | (pBiobu->rfv << 4);
		}
		...
		((Secumod *)0xFC040000U)->SECUMOD_PIOBU[ucPiobu] = dwTmp;
	}
}
...
void secumod_piobu_set_dynamic_mode(uint8_t pair)
{
	...
	reg = &((Secumod *)0xFC040000U)->SECUMOD_PIOBU[pair * 2];

	tmp = reg[0] & ~((0xFu << 4) | (0xfu << 0));
	reg[0] = tmp | (0x1u << 20);

	tmp = reg[1] & ~((0xFu << 4) | (0xfu << 0));
	reg[1] = tmp;
}
		...
		uint8_t reset_filter1, uint8_t alarm_filter1)
{
	...
	tmp = reg[0];
	tmp &= ~((0x1u << 20) | (0xFu << 4) | (0xfu << 0));
	reg[0] = tmp | (((0xFu << 4) & ((reset_filter0) << 4))) | (((0xfu << 0) & ((alarm_filter0) << 0)));

	tmp = reg[1];
	tmp &= ~((0xFu << 4) | (0xfu << 0));
	reg[0] = tmp | (((0xFu << 4) & ((reset_filter1) << 4))) | (((0xfu << 0) & ((alarm_filter1) << 0)));
}
...
void secumod_set_jtag_protection(_Bool force_reset, uint8_t debug_permissions,
		_Bool ack_monitoring)
{
	uint32_t jtag_cr;

	jtag_cr = debug_permissions << 1;
	...
	((Secumod *)0xFC040000U)->SECUMOD_JTAGCR = jtag_cr;
}
...
{
	uint32_t dystune;
	dystune = ((Secumod *)0xFC040000U)->SECUMOD_DYSTUNE & (0x1u << 7);
	dystune |= (((0xffffu << 16) & ((period) << 16)));
	dystune |= (((0x7fu << 0) & ((detection_thr) << 0)));
	dystune |= (((0xffu << 8) & ((reset_thr) << 8)));
	((Secumod *)0xFC040000U)->SECUMOD_DYSTUNE = dystune;
}
...
void secumod_periodic_alarm(_Bool enable)
{
	uint32_t tmp;

	tmp = ((Secumod *)0xFC040000U)->SECUMOD_DYSTUNE & ~(0x1u << 7);
	if (!enable)
		tmp |= (0x1u << 7);
	((Secumod *)0xFC040000U)->SECUMOD_DYSTUNE = tmp;
}
...
{
	((Secumod *)0xFC040000U)->SECUMOD_SCRKEY = key;
}
...
{
	return ((Secumod *)0xFC040000U)->SECUMOD_SCRKEY;
}
...
{
	uint32_t tmp;
	tmp = ((Secumod *)0xFC040000U)->SECUMOD_RAMACC & ~( 0x3u << ( 2 * (region) ) );
	((Secumod *)0xFC040000U)->SECUMOD_RAMACC = tmp | (rights << ( 2 * (region) ));
}
...
{
	((Secumod *)0xFC040000U)->SECUMOD_BMPR = sources;
}
...
{
	return ((Secumod *)0xFC040000U)->SECUMOD_BMPR;
}
...
{
	((Secumod *)0xFC040000U)->SECUMOD_NMPR = sources;

	if (((Secumod *)0xFC040000U)->SECUMOD_NMPR != sources) {
...
{
	return ((Secumod *)0xFC040000U)->SECUMOD_NMPR;
}
...
{
	((Secumod *)0xFC040000U)->SECUMOD_WKPR = sources;
}
...
{
	return ((Secumod *)0xFC040000U)->SECUMOD_WKPR;
}
...
{
	((Secumod *)0xFC040000U)->SECUMOD_NIEPR = sources;
	if (sources) {
...
{
	((Secumod *)0xFC040000U)->SECUMOD_NIDPR = sources;
	if ((0x00FF3CEFu) == (sources & (0x00FF3CEFu))) {
...
{
	return ((Secumod *)0xFC040000U)->SECUMOD_NIMPR;
}
...
uint32_t secumod_read_internal_memory(uint8_t *data, uint32_t addr, uint32_t size)
{
	...
	if (addr >= ((uint32_t)((Securam *)0xF8044000U)))
		addr -= ((uint32_t)((Securam *)0xF8044000U));

	for (i = 0; i < size; i += count)
	{
		region = (addr + i) >> 10;
		if ((( 0x0u << ( 2 * (region) ) ) ==
				(((Secumod *)0xFC040000U)->SECUMOD_RAMACC & ( 0x3u << ( 2 * (region) ) ))) ||
			(( 0x1u << ( 2 * (region) ) ) ==
				(((Secumod *)0xFC040000U)->SECUMOD_RAMACC & ( 0x3u << ( 2 * (region) ) ))))
		{
			break;
		...
		memcpy(data + i, (uint8_t *)(((uint32_t)((Securam *)0xF8044000U)) + addr + i), count);
	}
	return i;
}
...
uint32_t secumod_write_internal_memory(uint8_t *data, uint32_t addr, uint32_t size)
{
	...
	for (i = 0; i < size; i += count)
	{
		...
		memcpy((uint8_t *)(((uint32_t)((Securam *)0xF8044000U)) + addr + i), data + i, count);
	}
	return i;
}

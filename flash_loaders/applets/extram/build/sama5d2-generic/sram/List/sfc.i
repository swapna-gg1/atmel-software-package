...
{
	uint32_t status = ((Sfc *)0xF804C000U)->SFC_SR;
	uint32_t err = 0;
...
{
	((index < (sizeof ((((Sfc *)0xF804C000U)->SFC_DR)) / sizeof(*(((Sfc *)0xF804C000U)->SFC_DR)))) ? (void) 0 : (__aeabi_assert("index < (sizeof ((((Sfc *)0xF804C000U)->SFC_DR)) / sizeof(*(((Sfc *)0xF804C000U)->SFC_DR)))", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\nvm\\sfc.c", 74), (__iar_EmptyStepPoint())));
	return ((Sfc *)0xF804C000U)->SFC_DR[index];
}

void sfc_enable(void)
{
	pmc_enable_peripheral((50));
}

void sfc_disable(void)
{
	pmc_disable_peripheral((50));
}
...
_Bool sfc_write(uint32_t index, uint32_t data)
{
	...
	((Sfc *)0xF804C000U)->SFC_KR = (((0xffu << 0) & ((0xFB) << 0)));

	 
	((Sfc *)0xF804C000U)->SFC_DR[index] = data;

	 
	do {
		status = ((Sfc *)0xF804C000U)->SFC_SR;
...
{
	((Sfc *)0xF804C000U)->SFC_MR |= (0x1u << 0);
}

_Bool sfc_are_data_registers_masked(void)
{
	return (((Sfc *)0xF804C000U)->SFC_MR & (0x1u << 0)) != 0;
}

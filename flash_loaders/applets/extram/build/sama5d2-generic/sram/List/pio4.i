#line 1 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\gpio\\pio4.c"
...
#line 64 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\gpio\\pio4.c"
...
#line 65 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\gpio\\pio4.c"
...
#line 66 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\gpio\\pio4.c"
...
#line 67 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\gpio\\pio4.c"
...
#line 69 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\gpio\\pio4.c"
...
#line 72 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\gpio\\pio4.c"
...
{
	((group < 5) ? (void) 0 : (__aeabi_assert("group < 5", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\gpio\\pio4.c", 124), (__iar_EmptyStepPoint())));
	return &((Pio *)0xFC038000U)->PIO_IO[group];
}
...
{
	static int i = 0;
	((i < ((sizeof ((_handlers)) / sizeof(*(_handlers))) - 1)) ? (void) 0 : (__aeabi_assert("i < ((sizeof ((_handlers)) / sizeof(*(_handlers))) - 1)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\gpio\\pio4.c", 159), (__iar_EmptyStepPoint())));
...
{
	int i;
	uint32_t status = ((Pio *)0xFC038000U)->PIO_IO[group].PIO_ISR;
...
static void _pio_handler(uint32_t source, void* user_arg)
{
	...
	if (group_mask & (1 << 0))
		_pio_handle_interrupt(0);


	if (group_mask & (1 << 1))
		_pio_handle_interrupt(1);


	if (group_mask & (1 << 2))
		_pio_handle_interrupt(2);


	if (group_mask & (1 << 3))
		_pio_handle_interrupt(3);
...
void pio_configure(const struct _pin *pin_list, uint32_t size)
{
	...
	for (i = 0; i < size; i++) {
		...
		if (pin->type == 7)
			pmc_configure_peripheral((18), ((void*)0), 1);


		 
		((Pio *)0xFC038000U)->S_PIO_IO[pin->group].S_PIO_SIONR = pin->mask;
...
void pio_set_debounce_filter(uint32_t cutoff)
{
	...
	((Pio *)0xFC038000U)->S_PIO_SCDR = cutoff;
...
{
	((Pio *)0xFC038000U)->PIO_WPMR = (0x50494Fu << 8) | (0x1u << 0);
}

void pio_disable_write_protect(void)
{
	((Pio *)0xFC038000U)->PIO_WPMR = (0x50494Fu << 8);
}

uint32_t pio_get_write_protect_violation_info(void)
{
	return ((Pio *)0xFC038000U)->PIO_WPSR;
}
...
{
	((pin) ? (void) 0 : (__aeabi_assert("pin", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\gpio\\pio4.c", 406), (__iar_EmptyStepPoint())));
	PioIo* pio = _pio_get_instance(pin->group);
...
{
	((pin) ? (void) 0 : (__aeabi_assert("pin", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\gpio\\pio4.c", 413), (__iar_EmptyStepPoint())));
	PioIo* pio = _pio_get_instance(pin->group);
	pio->PIO_IDR = pin->mask;
}

...
void aic_initialize(aic_handler_t irq_handler)
{
	...
	_aic_initialize(((Aic *)0xFC020000U), irq_handler);

	_aic_initialize(((Aic *)0xF803C000U), irq_handler);

	 
	uint32_t aicredir = (((0x7fffffffu << 1) & (((uint32_t)(0x5B6C0E26u)) << 1)));
	((Sfr *)0xF8030000U)->SFR_AICREDIR = (aicredir ^ ((Sfr *)0xF8030000U)->SFR_SN1) | (0x1u << 0);
...
{
	((Aic *)0xFC020000U)->AIC_SPU = (uint32_t)handler;

	if (((Sfr *)0xF8030000U)->SFR_AICREDIR == 0)
		((Aic *)0xF803C000U)->AIC_SPU = (uint32_t)handler;
...
{
	return ((Aic *)0xFC020000U)->AIC_ISR;
}

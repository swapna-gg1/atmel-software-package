#line 1 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\target\\sama5d2\\chip.c"
...
#line 35 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\target\\sama5d2\\chip.c"
...
#line 36 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\target\\sama5d2\\chip.c"
...
#line 38 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\target\\sama5d2\\chip.c"
#line 1 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\flash_loaders\\applets\\extram\\..\\..\\..\\drivers\\nvm/sfc.h"
...
#line 40 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\target\\sama5d2\\chip.c"
...
#line 41 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\target\\sama5d2\\chip.c"
...
#line 42 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\target\\sama5d2\\chip.c"
...
static const struct chipid _exid_names[] = {
	{ (0x0000005aul), "SAMA5D21-CU" },
	{ (0x00000059ul), "SAMA5D22-CU" },
	{ (0x00000069ul), "SAMA5D22-CN" },
	{ (0x00000058ul), "SAMA5D23-CU" },
	{ (0x00000004ul), "SAMA5D24-CX" },
	{ (0x00000014ul), "SAMA5D24-CU" },
	{ (0x00000012ul), "SAMA5D26-CU" },
	{ (0x00000011ul), "SAMA5D27-CU" },
	{ (0x00000021ul), "SAMA5D27-CN" },
	{ (0x00000010ul), "SAMA5D28-CU" },
	{ (0x00000020ul), "SAMA5D28-CN" },
	{ (0x00000053ul), "SAMA5D225-D1M" },
	{ (0x00000032ul), "SAMA5D27-D5M" },
	{ (0x00000033ul), "SAMA5D27-D1G" },
	{ (0x00000013ul), "SAMA5D28-D1G" },
};

 
static const struct _console_cfg _console_cfg[] = {
	{ ((Uart *)0xF8020000U), 115200, { 3, (1u << 3), 0, (0) }, { 3, (1u << 2), 0, (0) } },
	{ ((Uart *)0xF801C000U), 115200, { 1, (1u << 27), 2, (0) }, { 1, (1u << 26), 2, (0) } },
	{ ((Uart *)0xF8020000U), 115200, { 2, (1u << 8), 4, (0) }, { 2, (1u << 7), 4, (0) } },
	{ ((Uart *)0xF8024000U), 115200, { 3, (1u << 5), 1, (0) }, { 3, (1u << 4), 1, (0) } },
	{ ((Uart *)0xF8024000U), 115200, { 3, (1u << 24), 0, (0) }, { 3, (1u << 23), 0, (0) } },
	{ ((Uart *)0xF8024000U), 115200, { 3, (1u << 20), 2, (0) }, { 3, (1u << 19), 2, (0) } },
	{ ((Uart *)0xFC008000U), 115200, { 2, (1u << 13), 3, (0) }, { 2, (1u << 12), 3, (0) } },
	{ ((Uart *)0xFC008000U), 115200, { 3, (1u << 0), 2, (0) }, { 3, (1u << 31), 2, (0) } },
	{ ((Uart *)0xFC008000U), 115200, { 1, (1u << 12), 2, (0) }, { 1, (1u << 11), 2, (0) } },
	{ ((Uart *)0xFC00C000U), 115200, { 1, (1u << 4), 0, (0) }, { 1, (1u << 3), 0, (0) } },
};
...
static const struct peripheral_xdma *get_peripheral_xdma(uint32_t id, Xdmac *xdmac)
{
	...
	if (xdmac != ((Xdmac *)0xF0010000U) && xdmac != ((Xdmac *)0xF0004000U)) {
		return 0;
	}
...
const char* get_chip_name(void)
{
	...
	if ((((Chipid *)0xFC069000U)->CHIPID_CIDR & ~(0x1fu << 0)) ==
			(0x8a5c08c0ul)) {
		uint32_t exid = ((Chipid *)0xFC069000U)->CHIPID_EXID;
...
void get_romcode_console(struct _console_cfg* config)
{
	...
	if ((bcw & (1 << 22)) == 0) {
		uint32_t bsc_cr = ((Bsc *)0xF8048054U)->BSC_CR;
		if (bsc_cr & (1 << 2)) {
			uint32_t index = (bsc_cr & (0x3u << 0)) >> 0;
			bcw = ((Securam *)0xF8044000U)->BUREG[index];
		}
	}

	 
	console = (bcw & (0xfu << 12)) >> 12;
	if (console < (sizeof ((_console_cfg)) / sizeof(*(_console_cfg))))
...
Matrix* get_peripheral_matrix(uint32_t id)
{
	...
	for (i = 0; i < (sizeof ((_h64_peripherals)) / sizeof(*(_h64_peripherals))); i++)
		if (_h64_peripherals[i] == id)
			return ((Matrix *)0xF0018000U); 
	return ((Matrix *)0xFC03C000U); 
}
...
uint32_t get_peripheral_clock_matrix_div(uint32_t id)
{
	...
	if (matrix == ((Matrix *)0xFC03C000U)) {
		if (((Pmc *)0xF0014000U)->PMC_MCKR & (0x1u << 24))
			return 2;
		else
			return 1;
	}
...
_Bool is_peripheral_on_dma_controller(uint32_t peri_id, Xdmac *xdmac)
{
	Matrix *dmac_mtx = 0;
	Matrix *peri_mtx = get_peripheral_matrix(peri_id);
	uint32_t dmac_id = get_xdmac_id_from_addr(xdmac);

	((peri_id < (79) && dmac_id < (79)) ? (void) 0 : (__aeabi_assert("peri_id < (79) && dmac_id < (79)", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\target\\sama5d2\\chip.c", 250), (__iar_EmptyStepPoint())));
	dmac_mtx = get_peripheral_matrix(dmac_id);
	((peri_mtx != 0 && dmac_mtx != 0) ? (void) 0 : (__aeabi_assert("peri_mtx != 0 && dmac_mtx != 0", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\target\\sama5d2\\chip.c", 252), (__iar_EmptyStepPoint())));
	if (matrix_is_peripheral_secured(peri_mtx, peri_id)
		&& !matrix_is_peripheral_secured(dmac_mtx, dmac_id))
		return 0;
	return get_peripheral_xdma(peri_id, xdmac) != 0;
}
...
int32_t get_peripheral_fifo_depth(void* addr)
{
	...
	switch (tmp) {
	case (uint32_t)((Usart *)0xF8034200U):

	case (uint32_t)((Usart *)0xF8038200U):


	case (uint32_t)((Usart *)0xFC010200U):


	case (uint32_t)((Usart *)0xFC014200U):


	case (uint32_t)((Usart *)0xFC018200U):

		size = (32u);
		break;

	case (uint32_t)((Spi *)0xF8034400U):

	case (uint32_t)((Spi *)0xF8038400U):


	case (uint32_t)((Spi *)0xFC010400U):


	case (uint32_t)((Spi *)0xFC014400U):


	case (uint32_t)((Spi *)0xFC018400U):

		size = (32u);
		break;
	case (uint32_t)((Spi *)0xF8000000U):

	case (uint32_t)((Spi *)0xFC000000U):

		size = (16u);
		break;
	case (uint32_t)((Twi *)0xF8034600U):

	case (uint32_t)((Twi *)0xF8038600U):


	case (uint32_t)((Twi *)0xFC010600U):


	case (uint32_t)((Twi *)0xFC014600U):


	case (uint32_t)((Twi *)0xFC018600U):


	case (uint32_t)((Twi *)0xF8028000U):


	case (uint32_t)((Twi *)0xFC028000U):

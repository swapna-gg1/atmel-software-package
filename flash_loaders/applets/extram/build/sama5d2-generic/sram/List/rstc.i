...
#line 74 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\flash_loaders\\applets\\extram\\..\\..\\..\\drivers\\peripherals/rstc.h"
...
#line 93 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\flash_loaders\\applets\\extram\\..\\..\\..\\drivers\\peripherals/rstc.h"
...
{
	uint32_t mr = ((Rstc *)0xF8048000U)->RSTC_MR;
	if (enable) {
		mr |= (0x1u << 0);
	} else {
		mr &= ~(0x1u << 0);
	}
	((Rstc *)0xF8048000U)->RSTC_MR = mr | (0xA5u << 24);
}
...
void rstc_reset_processor_and_peripherals(void)
{
	...
	((Rstc *)0xF8048000U)->RSTC_CR = (0x1u << 2) | (0x1u << 0) | (0xA5u << 24);



}

#line 109 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\peripherals\\rstc.c"
...
void rstc_reset_all(void)
{
	...
	((Rstc *)0xF8048000U)->RSTC_CR = cr;
}

_Bool rstc_get_nrst_level(void)
{
	return (((Rstc *)0xF8048000U)->RSTC_SR & (0x1u << 16)) != 0;
}

_Bool rstc_is_user_reset_detected(void)
{
	return (((Rstc *)0xF8048000U)->RSTC_SR & (0x1u << 0)) != 0;
}

_Bool rstc_is_busy(void)
{
	return (((Rstc *)0xF8048000U)->RSTC_SR & (0x1u << 17)) != 0;
}

uint32_t rstc_get_status(void)
{
	return ((Rstc *)0xF8048000U)->RSTC_SR;
}

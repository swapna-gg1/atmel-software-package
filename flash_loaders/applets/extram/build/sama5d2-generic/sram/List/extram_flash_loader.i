		   ...
		   char const *argv[])
{
	...
	case 0:
		do { if (trace_level >= 3) printf("Preset 0 (4 x MT47H128M8)\r\n"); } while (0);
		device = MT47H128M8;
		break;
	...
	case 2:
		do { if (trace_level >= 3) printf("Preset 2 (2 x MT47H128M16)\r\n"); } while (0);
		device = MT47H128M16;
		break;


	case 3:
		do { if (trace_level >= 3) printf("Preset 3 (2 x MT42L128M16)\r\n"); } while (0);
		device = MT42L128M16;
		break;


	case 4:
		do { if (trace_level >= 3) printf("Preset 4 (2 x MT41K128M16)\r\n"); } while (0);
		device = MT41K128M16;
		break;
	case 12:
		do { if (trace_level >= 3) printf("Preset 12 (1 x MT41K128M16)\r\n"); } while (0);
		device = MT41K128M16_16;
		break;


	case 5:
		do { if (trace_level >= 3) printf("Preset 5 (EDF8164A3MA)\r\n"); } while (0);
		device = EDF8164A3MA;
		break;
#line 198 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\flash_loaders\\applets\\extram\\extram_flash_loader.c"
	case 8:
		do { if (trace_level >= 3) printf("Preset 8 (W971GG6SB)\r\n"); } while (0);
		device = W971GG6SB;
		break;
	...
	case 15:
		do { if (trace_level >= 3) printf("Preset 15 (W9712G6KB)\r\n"); } while (0);
		device = W9712G6KB;
		break;


	case 16:
		do { if (trace_level >= 3) printf("Preset 16 (W9751G6KB)\r\n"); } while (0);
		device = W9751G6KB;
		break;


#line 234 "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\flash_loaders\\applets\\extram\\extram_flash_loader.c"
	case 13:
		do { if (trace_level >= 3) printf("Preset 13 (AD220032D)\r\n"); } while (0);
		device = AD220032D;
		break;


	case 14:
		do { if (trace_level >= 3) printf("Preset 14 (AD210032D)\r\n"); } while (0);
		device = AD210032D;
		break;

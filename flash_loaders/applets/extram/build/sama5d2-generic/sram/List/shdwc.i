...
void shdwc_configure_wakeup_mode(uint32_t config)
{
	...
	cfg.uint32_value = ((Shdwc *)0xF8048010U)->SHDW_MR;

	cfg.bfield.lpdbcen0 = (config & (0x1u << 0)) ? 1 : 0;
	cfg.bfield.lpdbcen1 = (config & (0x1u << 1)) ? 1 : 0;
	cfg.bfield.lpdbc = (config & (0x7u << 8)) >> 8;
	cfg.bfield.rttwken = (config & (0x1u << 16)) ? 1 : 0;
	cfg.bfield.rtcwken = (config & (0x1u << 17)) ? 1 : 0;
	cfg.bfield.accwken = (config & (0x1u << 18)) ? 1 : 0;
	cfg.bfield.rxlpwken = (config & (0x1u << 19)) ? 1 : 0;
	cfg.bfield.wkupdbc = (config & (0x7u << 24)) >> 24;

	((Shdwc *)0xF8048010U)->SHDW_MR = cfg.uint32_value;
}
...
void shdwc_set_wakeup_input(uint32_t input_enable, uint32_t input_type)
{
	...
	((Shdwc *)0xF8048010U)->SHDW_WUIR = wuir;
}

void shdwc_set_wakeup_debounce(uint32_t debounce)
{
	((Shdwc *)0xF8048010U)->SHDW_MR = (((Shdwc *)0xF8048010U)->SHDW_MR & ~(0x7u << 24))
	               | (debounce & (0x7u << 24));
}
...
void shdwc_configure_wakeup(void)
{
       ...
       shdwc_set_wakeup_input((0x1u << 0), (0x0u << 16));
...
{
	((Shdwc *)0xF8048010U)->SHDW_CR = (0xA5u << 24) | (0x1u << 0);
}

uint32_t shdwc_get_status(void)
{
	return ((Shdwc *)0xF8048010U)->SHDW_SR;
}

...
static void _init_mt41k128m16(struct _mpddrc_desc* desc, uint8_t bus_width)
{
	...
	desc->timings.tras  = ((((35) * (mck)) + 999) / 1000);          
	desc->timings.trcd  = ((((14) * (mck)) + 999) / 1000);          
	desc->timings.twr   = ((((15) * (mck)) + 999) / 1000);          
	desc->timings.trc   = ((((49) * (mck)) + 999) / 1000);          
	desc->timings.trp   = ((((14) * (mck)) + 999) / 1000);          
	desc->timings.trrd  = (((((((6) * (mck)) + 999) / 1000)) > (4)) ? (((((6) * (mck)) + 999) / 1000)) : (4));   
	desc->timings.twtr  = (((((((8) * (mck)) + 999) / 1000)) > (4)) ? (((((8) * (mck)) + 999) / 1000)) : (4));   
	desc->timings.tmrd  = 4;                           
	desc->timings.trfc  = ((((160) * (mck)) + 999) / 1000);         
	desc->timings.txsnr = ((((170) * (mck)) + 999) / 1000);         
	desc->timings.txp   = (((((((14) * (mck)) + 999) / 1000)) > (10)) ? (((((14) * (mck)) + 999) / 1000)) : (10)); 
	desc->timings.trtp  = (((((((8) * (mck)) + 999) / 1000)) > (4)) ? (((((8) * (mck)) + 999) / 1000)) : (4));   
	desc->timings.tfaw  = ((((40) * (mck)) + 999) / 1000);          
...
static void _init_edf8164a3ma(struct _mpddrc_desc* desc)
{
	...
	memset(&desc->timings, 0, sizeof(desc->timings));
	desc->timings.tras  = ((((42) * (mck)) + 999) / 1000);          
	desc->timings.trcd  = (((((((18) * (mck)) + 999) / 1000)) > (3)) ? (((((18) * (mck)) + 999) / 1000)) : (3));  
	desc->timings.twr   = (((((((15) * (mck)) + 999) / 1000)) > (3)) ? (((((15) * (mck)) + 999) / 1000)) : (3));  
	desc->timings.trc   = ((((55) * (mck)) + 999) / 1000);          
	desc->timings.trp   = (((((((8) * (mck)) + 999) / 1000)) > (4)) ? (((((8) * (mck)) + 999) / 1000)) : (4));   
	desc->timings.trrd  = (((((((10) * (mck)) + 999) / 1000)) > (2)) ? (((((10) * (mck)) + 999) / 1000)) : (2));  
	desc->timings.twtr  = (((((((8) * (mck)) + 999) / 1000)) > (4)) ? (((((8) * (mck)) + 999) / 1000)) : (4));   
	desc->timings.tmrd  = (((((((14) * (mck)) + 999) / 1000)) > (10)) ? (((((14) * (mck)) + 999) / 1000)) : (10)); 
	desc->timings.trfc  = ((((130) * (mck)) + 999) / 1000);         
	desc->timings.txsnr = ((((140) * (mck)) + 999) / 1000);         
	desc->timings.txp   = (((((((8) * (mck)) + 999) / 1000)) > (2)) ? (((((8) * (mck)) + 999) / 1000)) : (2));   
	desc->timings.trtp  = (((((((8) * (mck)) + 999) / 1000)) > (4)) ? (((((8) * (mck)) + 999) / 1000)) : (4));   
	desc->timings.tfaw  = (((((((50) * (mck)) + 999) / 1000)) > (8)) ? (((((50) * (mck)) + 999) / 1000)) : (8));  
...
static void _init_w971gg6sb(struct _mpddrc_desc* desc)
{
	...
	((mck >= 125 && mck <= 200) ? (void) 0 : (__aeabi_assert("mck >= 125 && mck <= 200", "C:\\work\\AtmelSoftPAck\\atmel-software-package-2.17\\drivers\\extram\\ddram.c", 206), (__iar_EmptyStepPoint())));
	...
	desc->timings.twr    = ((((15) * (mck)) + 999) / 1000);   
	desc->timings.trc    = ((((53) * (mck)) + 999) / 1000);   
	...
	desc->timings.trpa   = 1 + desc->timings.trp;  
...
static void _init_w9712g6kb(struct _mpddrc_desc* desc)
{
	...
	desc->timings.twtr   = ((((8) * (mck)) + 999) / 1000);   
	desc->timings.tmrd   = 2;                   
	desc->timings.trfc   = ((((75) * (mck)) + 999) / 1000);  
	desc->timings.txsnr  = ((((85) * (mck)) + 999) / 1000); 
	desc->timings.txsrd  = 200;                 
	desc->timings.txp    = 2;                   
	desc->timings.txard  = 2;                   
	desc->timings.txards = 8;                   
	desc->timings.trpa   = desc->timings.trp + 1; 
	desc->timings.trtp   = ((((8) * (mck)) + 999) / 1000);   
...
static void _init_w9751g6kb(struct _mpddrc_desc* desc)
{
	...
	desc->timings.trcd   = ((((14) * (mck)) + 999) / 1000);  
	desc->timings.twr    = ((((15) * (mck)) + 999) / 1000);  
	desc->timings.trc    = ((((59) * (mck)) + 999) / 1000);  
	desc->timings.trp    = ((((14) * (mck)) + 999) / 1000);  
	desc->timings.trrd   = ((((10) * (mck)) + 999) / 1000);  
	desc->timings.twtr   = 4;                   
	desc->timings.tmrd   = 4;                   
	desc->timings.trfc   = ((((105) * (mck)) + 999) / 1000); 
	desc->timings.txsnr  = ((((115) * (mck)) + 999) / 1000); 
	desc->timings.txsrd  = 200;                 
	desc->timings.txp    = 4;                   
	desc->timings.txard  = 4;                   
	desc->timings.txards = 12;                  
	desc->timings.trpa   = desc->timings.trp + 1; 
	desc->timings.trtp   = 4;                   
	desc->timings.tfaw   = ((((45) * (mck)) + 999) / 1000);  
...
static void _init_mt42l128m16(struct _mpddrc_desc* desc)
{
	...
	desc->timings.trp    = ((((15) * (mck)) + 999) / 1000);  
	desc->timings.trrd   = ((((11) * (mck)) + 999) / 1000);  
	desc->timings.twtr   = ((((8) * (mck)) + 999) / 1000);   
	desc->timings.tmrd   = 2;                   
	desc->timings.trfc   = ((((130) * (mck)) + 999) / 1000); 
	desc->timings.txsnr  = ((((140) * (mck)) + 999) / 1000); 
	desc->timings.txp    = 2;                   
	desc->timings.trtp   = ((((8) * (mck)) + 999) / 1000);   
	desc->timings.tfaw   = ((((50) * (mck)) + 999) / 1000);  
...
static void _init_ad220032d(struct _mpddrc_desc* desc)
{
	...
	memset(&desc->timings, 0, sizeof(desc->timings));
	desc->timings.tras   = ((((42) * (mck)) + 999) / 1000); 
	desc->timings.trcd   = ((((18) * (mck)) + 999) / 1000); 
	desc->timings.twr    = ((((15) * (mck)) + 999) / 1000); 
	desc->timings.trc    = ((((63) * (mck)) + 999) / 1000); 
	desc->timings.trp    = ((((21) * (mck)) + 999) / 1000); 
	desc->timings.trrd   = ((((10) * (mck)) + 999) / 1000); 
	desc->timings.twtr   = ((((10) * (mck)) + 999) / 1000); 
	desc->timings.tmrd   = 5;                   
	desc->timings.trfc   = ((((130) * (mck)) + 999) / 1000); 
	...
	desc->timings.txp    = 8;                   
	desc->timings.trtp   = ((((8) * (mck)) + 999) / 1000); 
	desc->timings.tfaw   = ((((60) * (mck)) + 999) / 1000); 
